...
#define VLDH_PASTEMODE_AREA 1
  ...
  int vldh_con_create(vldh_t_wind wind, pwr_tClassId classid, unsigned long drawtype, vldh_t_node source_node,
  ...
  int vldh_wind_create(vldh_t_plc plc, vldh_t_node parentnode, void* foe, pwr_tClassId classid,
