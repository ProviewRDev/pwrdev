...
pwr_tOid wb_bdef::boid() { return m_bdrep->boid(); }

pwr_eBix wb_bdef::bix() { return m_bdrep->bix(); }

size_t wb_bdef::size() { return m_bdrep->size(); }

int wb_bdef::nAttribute() { return m_bdrep->nAttribute(); }

const char* wb_bdef::name() const { return m_bdrep->name(); }

wb_name wb_bdef::longName() const { return m_bdrep->longName(); }

pwr_sAttrRef wb_bdef::aref() { return m_bdrep->aref(); }
