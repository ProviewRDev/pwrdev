...
wb_vrepdbms::wb_vrepdbms(wb_erep* erep, pwr_tVid vid, pwr_tCid cid, const char* volumeName,
                         const char* fileName)
    : m_erep(erep), m_nRef(0), m_ohead(), m_oid_th(0)
{
  strcpy(m_fileName, fileName);
...
wb_erep* wb_vrepdbms::erep() { return m_erep; }
...
wb_merep* wb_vrepdbms::merep() const { return m_merep; }

wb_srep* wb_vrepdbms::newSession() { return 0; }
...
bool wb_vrepdbms::copyOset(pwr_tStatus* sts, wb_oset* oset, wb_destination& d) { return false; }
...
bool wb_vrepdbms::writeAttribute(pwr_tStatus* sts, wb_orep* orp, pwr_eBix bix, size_t offset, size_t size,
                                 void* p)
{
  try
  {
...
void* wb_vrepdbms::readAttribute(pwr_tStatus* sts, const wb_orep* orp, pwr_eBix bix, size_t offset,
                                 size_t size, void* p)
{
  int rc = 0;
...
bool wb_vrepdbms::exportVolume(wb_import& i) { return i.importVolume(*this); }
...
bool wb_vrepdbms::exportDocBlock(wb_import& i) { return false; }

bool wb_vrepdbms::exportMeta(wb_import& i) { return false; }

bool wb_vrepdbms::exportTree(wb_treeimport& i, pwr_tOid oid) { return exportTreeHelper(i, oid, true); }
...
void wb_vrepdbms::delete_wb_orepdbms(void* p) { free(p); }

bool wb_vrepdbms::importPasteObject(pwr_tOid doid, ldh_eDest destcode, bool keepoid, pwr_tOid oid,
