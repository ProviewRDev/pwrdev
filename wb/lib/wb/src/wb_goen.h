...
int goen_create_nodetype(flow_tCtx ctx, pwr_tClassId classid, ldh_tSesContext ldhses, unsigned int* mask,
                         unsigned long subwindowmark, unsigned long node_width, flow_tNode* node_class,
                         vldh_t_node node);

int goen_get_parinfo(WGre* grectx, pwr_tClassId classid, ldh_tSesContext ldhses, unsigned int* mask,
...
int goen_get_pointinfo(WGre* grectx, pwr_tClassId classid, ldh_tSesContext ldhses, unsigned int* mask,
                       unsigned long node_width, unsigned long con_point, goen_conpoint_type* graph_pointer,
                       vldh_t_node node);

int goen_get_parameter(pwr_tClassId classid, ldh_tSesContext ldhses, unsigned int* mask,
                       unsigned long con_point, unsigned long* par_type, unsigned long* par_inverted,
                       unsigned long* par_index);

int goen_get_location_point(WGre* grectx, pwr_tClassId classid, ldh_tSesContext ldhses, unsigned int* mask,
