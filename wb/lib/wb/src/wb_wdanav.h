...
#define WDANAV_BROW_MAX 25
  ...
  {
  public:
    WdaNav(void* wa_parent_ctx, const char* wa_name, ldh_tSesContext wa_ldhses, pwr_tObjid wa_objid,
    ...
    int update(pwr_tObjid new_objid, pwr_tClassId new_classid, char* new_attribute, int new_attrobjects,
