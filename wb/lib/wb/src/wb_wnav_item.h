...
public:
  ...
  int open_attribute(WNav* wnav, double x, double y, char* attr_name, int element);
...
{
public:
  WItemObject(WNav* wnav, pwr_tObjid item_objid, brow_tNode dest, flow_eDest dest_code, int item_is_root);
  virtual ~WItemObject();
};
...
{
public:
  WItemMenu(WNav* wnav, const char* item_name, brow_tNode dest, flow_eDest dest_code,
...
{
public:
  WItemCommand(WNav* wnav, const char* item_name, brow_tNode dest, flow_eDest dest_code, char* item_command,
...
{
public:
  WItemLocal(WNav* wnav, const char* item_name, const char* attr, int attr_type, int attr_size,
...
{
public:
  WItemLocalEnum(WNav* wnav, char* item_name, int item_num, int item_type_id, int item_nochange,
...
{
public:
  WItemText(WNavBrow* brow, const char* item_name, char* text, brow_tNode dest, flow_eDest dest_code);
  virtual ~WItemText();
};
...
{
public:
  WItemHeader(WNavBrow* brow, const char* item_name, const char* title, brow_tNode dest,
              flow_eDest dest_code);
  virtual ~WItemHeader();
};
...
{
public:
  WItemHeaderLarge(WNavBrow* brow, const char* item_name, char* title, brow_tNode dest, flow_eDest dest_code);
...
{
public:
  WItemVolume(WNav* wnav, pwr_tVolumeId item_volid, brow_tNode dest, flow_eDest dest_code);
  virtual ~WItemVolume();
  pwr_tVolumeId volid;
...
{
public:
  WItemObjectName(WNavBrow* item_brow, ldh_tSesContext item_ldhses, pwr_tObjid item_objid, brow_tNode dest,
                  flow_eDest dest_code);
...
{
public:
  WItemObjectModTime(WNavBrow* item_brow, ldh_tSesContext item_ldhses, pwr_tObjid item_objid, brow_tNode dest,
                     flow_eDest dest_code);
...
{
public:
  WItemDocBlock(WNavBrow* item_brow, ldh_tSesContext item_ldhses, pwr_tObjid item_objid, char* block,
                int item_size, brow_tNode dest, flow_eDest dest_code);
...
{
public:
  WItemFile(WNav* wnav, const char* item_name, char* text, char* file, item_eFileType item_filetype,
...
{
public:
  WItemCrossref(WNavBrow* item_brow, ldh_tSesContext item_ldhses, char* item_ref_name, char* item_ref_class,
...
{
public:
  WItemBaseAttr(WNavBrow* item_brow, ldh_tSesContext item_ldhses, pwr_tObjid item_objid, char* attr_name,
                int attr_type_id, pwr_tTid attr_tid, int attr_size, int attr_flags, char* attr_body);
...
{
public:
  WItemAttr(WNavBrow* item_brow, ldh_tSesContext item_ldhses, pwr_tObjid item_objid, brow_tNode dest,
            flow_eDest dest_code, char* attr_name, int attr_type_id, pwr_tTid attr_tid, int attr_size,
...
{
public:
  WItemAttrInput(WNavBrow* item_brow, ldh_tSesContext item_ldhses, pwr_tObjid item_objid, brow_tNode dest,
                 flow_eDest dest_code, char* attr_name, int attr_type_id, pwr_tTid attr_tid, int attr_size,
...
{
public:
  WItemAttrInputF(WNavBrow* item_brow, ldh_tSesContext item_ldhses, pwr_tObjid item_objid, brow_tNode dest,
                  flow_eDest dest_code, char* attr_name, int attr_type_id, pwr_tTid attr_tid, int attr_size,
                  int attr_flags, char* attr_body, int attr_input_num);
...
{
public:
  WItemAttrInputInv(WNavBrow* item_brow, ldh_tSesContext item_ldhses, pwr_tObjid item_objid, brow_tNode dest,
                    flow_eDest dest_code, char* attr_name, int attr_type_id, pwr_tTid attr_tid, int attr_size,
                    int attr_flags, char* attr_body, int attr_input_num);
...
{
public:
  WItemAttrOutput(WNavBrow* item_brow, ldh_tSesContext item_ldhses, pwr_tObjid item_objid, brow_tNode dest,
                  flow_eDest dest_code, char* attr_name, int attr_type_id, pwr_tTid attr_tid, int attr_size,
...
public:
  int elements;
  WItemAttrArray(WNavBrow* item_brow, ldh_tSesContext item_ldhses, pwr_tObjid item_objid, brow_tNode dest,
                 flow_eDest dest_code, char* attr_name, int attr_elements, int attr_type_id,
                 pwr_tTid attr_tid, int attr_size, int attr_flags, char* attr_body, int fullname);
...
public:
  int elements;
  unsigned int mask;
  WItemAttrArrayOutput(WNavBrow* item_brow, ldh_tSesContext item_ldhses, pwr_tObjid item_objid,
...
public:
  int element;
  int offset;
  WItemAttrArrayElem(WNavBrow* item_brow, ldh_tSesContext item_ldhses, pwr_tObjid item_objid, brow_tNode dest,
                     flow_eDest dest_code, char* attr_name, int attr_element, int attr_type_id,
                     pwr_tTid attr_tid, int attr_size, int attr_offset, int attr_flags, char* attr_body);
...
public:
  ...
  WItemAttrObject(WNavBrow* item_brow, ldh_tSesContext item_ldhses, pwr_tObjid item_objid, brow_tNode dest,
                  flow_eDest dest_code, char* attr_name, int attr_type_id, int attr_size, bool attr_is_elem,
...
{
public:
  WItemEnum(WNavBrow* item_brow, ldh_tSesContext item_ldhses, pwr_tObjid item_objid, char* attr_enum_name,
            char* attr_name, int attr_type_id, pwr_tTid attr_tid, int attr_size, int attr_flags,
            char* attr_body, unsigned int item_num, int item_is_element, int item_element, brow_tNode dest,
            flow_eDest dest_code);
  virtual ~WItemEnum();
  char enum_name[80];
  unsigned int num;
...
{
public:
  WItemMask(WNavBrow* item_brow, ldh_tSesContext item_ldhses, pwr_tObjid item_objid, char* attr_mask_name,
            char* attr_name, int attr_type_id, pwr_tTid attr_tid, int attr_size, int attr_flags,
            char* attr_body, unsigned int item_mask, int item_is_element, int item_element, brow_tNode dest,
            flow_eDest dest_code);
  virtual ~WItemMask();
  char mask_name[40];
  unsigned int mask;
...
{
public:
  WItemEnumObject(WNavBrow* item_brow, ldh_tSesContext item_ldhses, pwr_tObjid item_objid,
