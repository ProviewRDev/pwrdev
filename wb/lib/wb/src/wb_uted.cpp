...
uted_sCommand WUted::commands[UTED_MAX_COMMANDS] = {
    ...
    {"Show Modules",
     ...
     {{"Name", 1, UTED_INS_PLNO, 1, 0, UTED_QUAL_QUAL},
      ...
      {"Output", 0, 0, 1, 0, UTED_QUAL_QUAL},
      {"", 0, 0, 0, 0, UTED_QUAL_QUAL}}},
    {"Show Security", UTED_PROC_PWRPLC, 1, 1, {{"", 0, 0, 0, 0, UTED_QUAL_QUAL}}},
    {"Compile",
     UTED_PROC_PWRPLC,
     0,
     3,
    ...
    {"Create StructFiles",
     ...
     0,
     1,
     {{"Files", 0, 0, 1, 0, UTED_QUAL_QUAL}, {"", 0, 0, 0, 0, UTED_QUAL_QUAL}}},
    {"Create LoadFiles",
     UTED_PROC_PWRPLC,
     0,
     1,
    ...
    {"Create BootFiles",
     ...
     {{"NodeConfig", 0, 0, 1, 0, UTED_QUAL_QUAL},
      ...
      {"Debug", 0, 0, 0, 1, UTED_QUAL_QUAL},
      {"", 0, 0, 0, 0, UTED_QUAL_QUAL}}},
    {"Create RttFiles", UTED_PROC_PWRPLC, 0, 1, {{"", 0, 0, 0, 0, UTED_QUAL_QUAL}}},
    {"Delete Object",
     UTED_PROC_PWRPLC,
     0,
     1,
...
//
WUted::WUted(void* wu_parent_ctx, const char* wu_name, const char* wu_iconname, ldh_tWBContext wu_ldhwb,
             ldh_tSesContext wu_ldhses, int wu_editmode, void (*wu_quit_cb)(void*), pwr_tStatus* status)
    : parent_ctx(wu_parent_ctx), current_index(0), ldhwb(wu_ldhwb), ldhses(wu_ldhses), quit_cb(wu_quit_cb)
{
  strcpy(name, wu_name);
  *status = FOE__SUCCESS;
}
