...
int goen_create_nodetype_m2(pwr_sGraphPlcNode* graphbody, pwr_tClassId cid, ldh_tSesContext ldhses,
                            ...
                            unsigned long node_width, flow_tNodeClass* node_class, vldh_t_node node)
{
  ...
  if (graphbody->graphmethod != 9)
  {
    ...
    flow_AddAnnot(nc_pid, f_width / 2 - annot_width[0] / 2,
                  f_height - (f_repeat - f_strheight) / 2.0 - f_yoffs, 2, flow_eDrawType_TextRoboto,
 ...
 *
 **************************************************************************/
int goen_get_point_info_m2(WGre* grectx, pwr_sGraphPlcNode* graphbody, unsigned long point,
 ...
 *
 **************************************************************************/
int goen_get_parameter_m2(pwr_sGraphPlcNode* graphbody, pwr_tClassId cid, ldh_tSesContext ldhses,
 ...
 *
 **************************************************************************/
int goen_get_location_point_m2(WGre* grectx, pwr_sGraphPlcNode* graphbody, unsigned int* mask,
