...
#define ldh_isSymbolicVid(vid)                                                                               \
  ((vid) == ldh_cPlcMainVolume || (vid) == ldh_cPlcFoVolume || (vid) == ldh_cIoConnectVolume)
...
#define ldh_mMenuFlags_Sensitive 1
  ...
  pwr_tStatus ldh_AttachVolume(ldh_tWorkbench Workbench, pwr_tVolumeId vid, ldh_tVolContext* VolContext);

  pwr_tStatus ldh_SAttachVolume(ldh_tWorkbench Workbench, pwr_tVolumeId vid, ldh_tVolContext* VolContext);

  pwr_tStatus ldh_AttrRefToName(ldh_tSession Session, pwr_sAttrRef* AttrRef, int NameType, char** Name,
                                int* Size);
  ...
  pwr_tStatus ldh_ChangeObjectName(ldh_tSession Session, pwr_tObjid object, char* newname);

  pwr_tStatus ldh_CheckAttrXRef(ldh_tSession Session, pwr_sAttrRef* PattrRef);

  pwr_tStatus ldh_CheckAttrXRefs(ldh_tSession Session, pwr_sAttrRef* PattrRef, pwr_sAttrRef* SattrRef);

  pwr_tStatus ldh_CheckObjXRef(ldh_tSession Session, pwr_tObjid Pobject, pwr_tObjName PattrName);

  pwr_tStatus ldh_CheckObjXRefs(ldh_tSession Session, pwr_tObjid Pobject, pwr_tObjName PattrName,
                                pwr_tObjid Sobject, pwr_tObjName SattrName);

  pwr_tStatus ldh_ClassIdToName(ldh_tSession Session, pwr_tClassId Class, char* namebuf, int maxsize,
                                int* size);

  pwr_tStatus ldh_ClassNameToId(ldh_tSession Session, pwr_tClassId* Class, const char* name);

  pwr_tStatus ldh_CloseSession(ldh_tSession Session);

  pwr_tStatus ldh_CloseWB(ldh_tWorkbench workbench);

  pwr_tStatus ldh_ConnectObjects(ldh_tSession Session, pwr_tObjid src_object, pwr_tObjid dst_object);

  pwr_tStatus ldh_ConnectObjectByXRef(ldh_tSession Session, pwr_tObjid srcdid /* objid of source object. */
  );

  pwr_tStatus ldh_Copy(ldh_tSession Session, pwr_sAttrRef* aref, int keepref, int keepsym, int ignore_errors);

  pwr_tStatus ldh_CopyObject(ldh_tSession Session, pwr_tObjid* object, char* name, pwr_tObjid source,
                             pwr_tObjid destination, ldh_eDest destination_code);

  pwr_tStatus ldh_CopyObjectTrees(ldh_tSession Session, pwr_sAttrRef* AttrRef, pwr_tObjid destobject,
                                  ldh_eDest dest, pwr_tBoolean Self, int keepref, int keepsym, int recycleix);

  pwr_tStatus ldh_CreateObject(ldh_tSession Session, pwr_tObjid* object, const char* name, pwr_tClassId Class,
                               pwr_tObjid destination, ldh_eDest destination_code);

  pwr_tStatus ldh_CreateVolume(ldh_tWorkbench workbench, ldh_tSession* session, pwr_tVid vid, char* name,
                               pwr_tClassId cid, ldh_eVolRep volrep, char* server);

  pwr_tStatus ldh_Cut(ldh_tSession session, pwr_sAttrRef* aref, int keepref);

  pwr_tStatus ldh_DefineObject(ldh_tSession Session, pwr_tObjid* Objid, char* Name, pwr_tObjectIx ObjectIx,
                               pwr_tClassId Class, pwr_tObjid DestinationObject, ldh_eDest DestinationCode,
                               int CreateBody /* Are bodies to be created or not ? */
  );

  pwr_tStatus ldh_DefineObjectBody(ldh_tSession Session, pwr_tObjid object, char* bodyname, char* body,
                                   int size);
  pwr_tStatus ldh_DeleteObject(ldh_tSession Session, pwr_tObjid object);
  pwr_tStatus ldh_DeleteObjectTree(ldh_tSession Session, pwr_tObjid object, int storeix);

  pwr_tStatus ldh_DeleteVolume(ldh_tWorkbench Workbench, pwr_tVolumeId Volume);

  pwr_tStatus ldh_DetachVolume(ldh_tWorkbench Workbench, ldh_tVolContext VolContext);
  ...
  pwr_tStatus ldh_GetAttrDef(ldh_tSession Session, pwr_tClassId Class, const char* BodyName,
                             const char* AttrName, ldh_sParDef* AttrDef);
  pwr_tStatus ldh_GetAttrRef(ldh_tSession Session, pwr_tObjid Object, char* AttrName, pwr_sAttrRef* AttrRef);
  pwr_tStatus ldh_GetAttrXRefDef(ldh_tSession Session, pwr_sAttrRef* AttrRef, pwr_sAttrXRef* AttrXRef);
  pwr_tStatus ldh_GetChild(ldh_tSession Session, pwr_tObjid object, pwr_tObjid* new_object);
  pwr_tStatus ldh_GetChildMnt(ldh_tSession Session, pwr_tObjid object, pwr_tObjid* new_object);
  pwr_tStatus ldh_GetClassBody(ldh_tSession Session, pwr_tClassId Class, const char* bodyname,
                               pwr_tClassId* bodyclass, char** body, int* size);
  pwr_tStatus ldh_GetClassList(ldh_tSession Session, pwr_tClassId Class, pwr_tObjid* objid);
  ...
  pwr_tStatus ldh_GetNextObject(ldh_tSession Session, pwr_tObjid object, pwr_tObjid* new_object);
  pwr_tStatus ldh_GetNextAttrRef(ldh_tSession session, pwr_tCid cid, pwr_sAttrRef* arp,
  ...
  pwr_tStatus ldh_GetNextSibling(ldh_tSession Session, pwr_tObjid object, pwr_tObjid* new_object);
  pwr_tStatus ldh_GetObjectBody(ldh_tSession Session, pwr_tObjid object, const char* bodyname, void** body,
                                int* size);
  pwr_tStatus ldh_GetObjectBodyDef(ldh_tSession Session, pwr_tClassId Class, const char* bodyname, int maxlev,
                                   ldh_sParDef** bodydef, int* rows);
  pwr_tStatus ldh_GetTrueObjectBodyDef(ldh_tSession Session, pwr_tClassId Class, char* bodyname, int maxlev,
                                       ldh_sParDef** bodydef, int* rows);
  pwr_tStatus ldh_GetObjectBuffer(ldh_tSession Session, pwr_tObjid object, const char* bodyname,
                                  const char* buffername, pwr_eClass* bufferclass, char** buff, int* size);
  pwr_tStatus ldh_GetObjectClass(ldh_tSession Session, pwr_tObjid object, pwr_tClassId* Class);
  ...
  pwr_tStatus ldh_GetObjectContext(ldh_tSession Session, pwr_tObjid object, ldh_sObjContext** object_context);
  pwr_tStatus ldh_GetObjectNode(ldh_tSession Session, pwr_tObjid object, pwr_tObjid* wnode,
                                pwr_tObjid* anode);
  pwr_tStatus ldh_GetObjectInfo(ldh_tSession Session, pwr_tObjid object, ldh_sObjInfo* Info);
  pwr_tStatus ldh_GetObjectPar(ldh_tSession Session, pwr_tObjid object, const char* bodyname,
                               const char* parname, char** buff, int* size);
  pwr_tStatus ldh_GetAttrObjectPar(ldh_tSession Session, pwr_sAttrRef* arp, const char* bodyname,
                                   const char* parname, char** buff, int* size);
  pwr_tStatus ldh_GetObjXRefDef(ldh_tSession Session, pwr_sAttrRef* AttrRef, pwr_sObjXRef* ObjXRef);
  pwr_tStatus ldh_GetParent(ldh_tSession Session, pwr_tObjid object, pwr_tObjid* new_object);
  int ldh_IsAncestor(ldh_tSession session, pwr_tOid ancestor, pwr_tOid oid);
  pwr_tStatus ldh_GetPreviousObject(ldh_tSession Session, pwr_tObjid object, pwr_tObjid* new_object);
  pwr_tStatus ldh_GetPreviousSibling(ldh_tSession Session, pwr_tObjid object, pwr_tObjid* new_object);
  pwr_tStatus ldh_GetReferenceInfo(ldh_tSession Session, pwr_tObjid object, ldh_sRefInfo* RefInfo);
  ...
  pwr_tStatus ldh_GetUniqueObjectName(ldh_tSession Session, pwr_tObjid objid, char* Name);
  ...
  pwr_tStatus ldh_GetNextVolume(ldh_tWorkbench Workbench, pwr_tVolumeId Volume, pwr_tVolumeId* NewVolume);

  pwr_tStatus ldh_GetPreviousVolume(ldh_tWorkbench Workbench, pwr_tVolumeId Volume, pwr_tVolumeId* NewVolume);

  pwr_tStatus ldh_VolumeIdToName(ldh_tWorkbench Workbench, pwr_tVolumeId Volume, char* Name, int MaxSize,
                                 int* Size);

  pwr_tStatus ldh_VolumeNameToId(ldh_tWorkbench Workbench, char* Name, pwr_tVolumeId* Volume);

  pwr_tStatus ldh_GetVolumeClass(ldh_tWorkbench Workbench, pwr_tVolumeId Volume, pwr_tClassId* Class);

  pwr_tStatus ldh_IsOkCopyObject(ldh_tSession Session, pwr_tObjid Object, pwr_tObjid DestinationObject,
                                 ldh_eDest DestinationCode);

  pwr_tStatus ldh_IsOkCreateObject(ldh_tSession Session, pwr_tClassId Class, pwr_tObjid DestinationObject,
                                   ldh_eDest DestinationCode);

  pwr_tStatus ldh_IsOkMoveObject(ldh_tSession Session, pwr_tObjid Object, pwr_tObjid DestinationObject,
                                 ldh_eDest DestinationCode);

  pwr_tStatus ldh_MoveObject(ldh_tSession session, pwr_tObjid object, pwr_tObjid destinationObject,
                             ldh_eDest destinationCode);

  pwr_tStatus ldh_NameToAttrRef(ldh_tSession session, char* attrName, pwr_sAttrRef* attrRef);

  pwr_tStatus ldh_ArefANameToAref(ldh_tSession session, pwr_sAttrRef* arp, const char* aname,
                                  pwr_sAttrRef* oarp);

  pwr_tStatus ldh_NameToObjid(ldh_tSession session, pwr_tObjid* objid, const char* name);

  pwr_tStatus ldh_ObjidToName(ldh_tSession session, pwr_tObjid objid, int nameType, char* nameBuffer,
  ...
  pwr_tStatus ldh_OpenSession(ldh_tSession* Session, ldh_tVolContext Volume, ldh_eAccess Access,
                              ldh_eUtility Utility);

  pwr_tStatus ldh_OpenWB(ldh_tWorkbench* WorkBench, char* db, unsigned int options);

  pwr_tStatus ldh_Paste(ldh_tSession Session, pwr_tObjid dstoid, ldh_eDest dest, int keepoid, int recycleix,
                        char* buffer);

  pwr_tStatus ldh_ReadAttribute(ldh_tSession Session, pwr_sAttrRef* AttrRef, void* PointerToAttributeValue,
                                int Size);

  pwr_tStatus ldh_ReadObjectBody(ldh_tSession Session, pwr_tObjid object, const char* bodyname, void* body,
                                 int size);
  ...
  pwr_tStatus ldh_SetObjectBody(ldh_tSession Session, pwr_tObjid object, const char* bodyname, char* body,
                                int size);
  pwr_tStatus ldh_SetObjectBuffer(ldh_tSession Session, pwr_tObjid object, const char* bodyname,
                                  const char* buffername, char* buff);
  pwr_tStatus ldh_SetObjectName(ldh_tSession session, pwr_tObjid object, const char* newname);
  pwr_tStatus ldh_SetObjectNode(ldh_tSession session, pwr_tObjid object, pwr_tObjid wnode, pwr_tObjid anode);
  pwr_tStatus ldh_SetObjectPar(ldh_tSession session, pwr_tObjid object, const char* bodyname,
                               const char* parname, char* buff, int size);

  pwr_tStatus ldh_SetSession(ldh_tSession session, ldh_eAccess access);

  pwr_tStatus ldh_StringGetAttribute(ldh_tSession Session, pwr_sAttrRef* attributeReference,
                                     pwr_tUInt32 maxSize, char* string);

  pwr_tStatus ldh_StringSetAttribute(ldh_tSession Session, pwr_sAttrRef* attributeReference, char* string,
                                     pwr_tBoolean write);

  pwr_tStatus ldh_TOpenWB(ldh_tWorkbench* workbench, int flag);

  pwr_tStatus ldh_WriteAttribute(ldh_tSession Session, pwr_sAttrRef* attributeReference,
                                 void* attributeValuePointer, int size);

  pwr_tStatus ldh_GetVolumeInfo(ldh_tVolContext volContext, ldh_sVolumeInfo* info);

  pwr_tStatus ldh_GetVidInfo(ldh_tWorkbench workbench, pwr_tVid vid, ldh_sVolumeInfo* info);

  pwr_tStatus ldh_TypeIdToName(ldh_tSession session, pwr_tTypeId type, char* namebuf, int maxsize, int* size);

  pwr_tBoolean ldh_LocalObject(ldh_tSession session, pwr_tObjid object);

  pwr_tStatus ldh_GetVolumeRootList(ldh_tSession session, pwr_tVolumeId volume, pwr_tObjid* object);
