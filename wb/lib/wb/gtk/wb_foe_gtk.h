...
struct s_widgets {
  ...
  GtkToolItem* tools_save;
  GtkToolItem* tools_build;
  GtkToolItem* tools_redraw;
  GtkToolItem* tools_singlelinetext;
  GtkToolItem* tools_bodytext;
  GtkToolItem* tools_textheader;
