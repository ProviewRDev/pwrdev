...
void WGeGtk::pop() { gtk_window_present(GTK_WINDOW(toplevel)); }
...
static gint nav_delete_event(GtkWidget* w, GdkEvent* event, gpointer wge) { return TRUE; }

WGeGtk::WGeGtk(GtkWidget* wge_parent_wid, void* wge_parent_ctx, char* wge_name, char* wge_filename,
               int wge_scrollbar, int wge_menu, int wge_navigator, int wge_width, int wge_height, int x,
               int y, char* object_name, int wge_modal = 0)
      ...
      parent_wid(wge_parent_wid), nav_shell(0), value_dialog(0), confirm_widget(0)
{
  ...
  graph = new GraphGtk(this, graph_form, "Plant", &grow_widget, &sts, "pwrp_exe:", graph_eMode_Runtime,
