...
#link option file exists and is not empty
  if [ -s $pwrp_exe/$FileName.opt ]; then
    ...
    ld_opt="`eval echo $pwr_obj/rt_io_user.o -lpwr_rt -lpwr_usbio_dummy -lpwr_usb_dummy -lpwr_pnak_dummy -lpwr_cifx_dummy -lpwr_nodave_dummy -lpwr_epl_dummy -lpwr_mqtt_dummy`"
  fi
