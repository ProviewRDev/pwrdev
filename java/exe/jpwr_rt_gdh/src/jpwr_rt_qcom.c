...
JNIEXPORT jobject JNICALL Java_jpwr_rt_Qcom_createQ(JNIEnv* env, jobject object, jint qix, jint nid,
                                                    jstring jname)
{
  ...
  qcomrCreateQ_cid = (*env)->GetMethodID(env, qcomrCreateQ_id, "<init>", "(III)V");
  ...
  jsts = (jint)sts;
  return_obj = (*env)->NewObject(env, qcomrCreateQ_id, qcomrCreateQ_cid, qid.qix, qid.nid, jsts);
 ...
 */
JNIEXPORT jobject JNICALL Java_jpwr_rt_Qcom_createIniEventQ(JNIEnv* env, jobject object, jstring jname)
{
 ...
 */
JNIEXPORT jobject JNICALL Java_jpwr_rt_Qcom_getIniEvent(JNIEnv* env, jobject object, jint qix, jint nid,
                                                        jint timeoutTime)
{
  ...
  qcomrGetIniEvent_cid = (*env)->GetMethodID(env, qcomrGetIniEvent_id, "<init>", "(ZZZZI)V");
  ...
  return_obj = (*env)->NewObject(env, qcomrGetIniEvent_id, qcomrGetIniEvent_cid, jterminate, jswapInit,
                                 jswapDone, jtimeout, jsts);
  return return_obj;
}

JNIEXPORT jobject JNICALL Java_jpwr_rt_Qcom_getString(JNIEnv* env, jobject object, jint qix, jint nid)
{
  int sts;
  ...
  jsts = (jint)sts;
  return_obj = (*env)->NewObject(env, cdhrString_id, cdhrString_cid, jdata, jsts);
  return return_obj;
}

JNIEXPORT jobject JNICALL Java_jpwr_rt_Qcom_putString(JNIEnv* env, jobject object, jint qix, jint nid,
                                                      jstring jdata)
{
  int sts;
  const char* data;
