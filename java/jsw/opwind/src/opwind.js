...
function OpWindMenu() {
  ...
  this.get_menu_cb = function (id, data, sts, result) {
    ...
    if (result.enable_language) self.add_menu_button(context, "Language");
    if (result.enable_alarmlist) {
      self.add_menu_button(context, "AlarmList");
      self.add_menu_button(context, "EventList");
    }
    if (result.enable_eventlog) self.add_menu_button(context, "EventLog");
    if (result.enable_navigator) self.add_menu_button(context, "Navigator");
    if (!result.disable_help) self.add_menu_button(context, "Help");
    if (!result.disable_proview) self.add_menu_button(context, "ProviewR");
  ...
  this.button_cb = function (text) {
    if (self.info.enable_language && text == "Language") {
      ...
      else window.open("ev.html?list=alarm", "_blank");
      ...
      if (
        ...
        window.alert("Not authorized for this operation");
      else window.open("ev.html?list=event", "_blank");
      ...
      if (
        ...
        window.alert("Not authorized for this operation");
      else window.alert("Not yet implemented");
      ...
      if (
        ...
        window.alert("Not authorized for this operation");
      else window.open("xtt.html", "_blank");
        ...
        for (var i = 0; i < self.info.buttons.length; i++) {
          if (self.info.buttons[i].text == text) {
            ...
            if (self.info.buttons[i].name != "") {
              ...
              var url;
              if (
                self.info.buttons[i].object != null &&
                self.info.buttons[i].object != ""
              )
                url =
                  "ge.html?graph=" +
                  name +
  ...
  this.get_version_cb = function (id, data, sts, result) {
    if (sts & 1) console.log("Version", result);
    else console.log("Version unknown");
  };
