...
pwr_tStatus wa_ldhtest::check_object(pwr_tOid oid) {
  ...
  if (ODD(sts)) {
    int found = 0;
    for (sts = ldh_GetChild(m_ldhses, p, &child); ODD(sts);
  ...
  for (sts = ldh_GetChild(m_ldhses, oid, &child); ODD(sts);
       sts = ldh_GetNextSibling(m_ldhses, child, &child)) {
...
void wa_ldhtest::ObjidToName(void) {
  sObjidToName d[] = {
      ...
      {"Test02-Ldh-LongName90123456789012345678901", LDH__SUCCESS, LDH__SUCCESS,
       pwr_cNOid},
      {"Test02-Ldh-TooLongName234567890123456789012", LDH__BADNAME, 0,
       pwr_cNOid}};
  pwr_tOName oname;
  int size;
  ...
  for (unsigned int i = 0; i < sizeof(d) / sizeof(d[0]); i++) {
    ...
    if (m_sts != d[i].sts1) {
      ...
      m_sts = ldh_ObjidToName(m_ldhses, d[i].oid, ldh_eName_Hierarchy, oname,
                              sizeof(oname), &size);
      if (m_sts != d[i].sts2) {
        ...
        if (strcmp(oname, d[i].name) != 0) {
          m_log->vlog('E', "ObjidToName, wrong object %s != %s, idx %d", oname,
                      d[i].name, i);
          return;
        }
      }
...
void wa_ldhtest::CreateObject(void) {
  sCreateObject d[] = {
      ...
      {"LongName90123456789012345678901", "Test-H3", pwr_cClass_PlantHier,
       LDH__SUCCESS, pwr_cNOid},
      {"TooLongName234567890123456789012", "Test-H3", pwr_cClass_PlantHier,
       LDH__BADNAME, pwr_cNOid},
      {"Invalid#Name", "Test-H3", pwr_cClass_PlantHier, LDH__BADNAME,
       pwr_cNOid}};
  pwr_tOid dest;
  ...
  for (unsigned int i = 0; i < sizeof(d) / sizeof(d[0]); i++) {
    if (strcmp(d[i].dest, "") != 0) {
      ...
      if (EVEN(m_sts)) {
        m_log->log('E', "CreateObject, destination ldh_NameToObjid", d[i].name,
                   m_sts);
        return;
      }
    } else {
    ...
    if (ODD(m_sts)) {
      ...
      if (strcmp(oname, name) != 0) {
        m_log->vlog('E', "CreateObject, wrong object %s != %s, idx %d", name,
                    oname, i);
        return;
      }
...
void wa_ldhtest::DeleteObject(void) {
  sDeleteObject d[] = {
      ...
      {"Del5", "Test-H2", pwr_cClass_Pwrt02_Component, LDH__SUCCESS,
       pwr_cNOid}};
  ...
  for (unsigned int i = 0; i < sizeof(d) / sizeof(d[0]); i++) {
    if (strcmp(d[i].dest, "") != 0) {
      ...
      m_sts = ldh_NameToObjid(m_ldhses, &dest, d[i].dest);
      if (EVEN(m_sts)) {
        m_log->log('E', "DeleteObject, destination ldh_NameToObjid", d[i].dest,
                   m_sts);
        return;
      }
    } else {
...
void wa_ldhtest::MoveObject(void) {
  ...
  strcpy(name, "TestObject");
  m_sts = ldh_CreateObject(m_ldhses, &oid, name, pwr_cClass_AArray100,
                           m_test_h1, ldh_eDest_IntoLast);
  if (EVEN(m_sts)) {
...
void wa_ldhtest::GetRootList(void) {
  ...
  m_sts = ldh_ObjidToName(m_ldhses, m_root, ldh_eName_Hierarchy, name,
                          sizeof(name), &size);
  if (EVEN(m_sts)) {
...
void wa_ldhtest::GetChild(void) {
  sGetChild d[] = {
      {"RootObject", "Child1", pwr_cClass_PlantHier, LDH__SUCCESS, 0, pwr_cNOid,
       pwr_cNOid},
      {"RootObject-ChildLess", "", pwr_cClass_PlantHier, LDH__NO_CHILD, 0,
       pwr_cNOid, pwr_cNOid},
      {"ChTest", "Ch1", pwr_cClass_PlantHier, LDH__SUCCESS, 1, pwr_cNOid,
       pwr_cNOid},
      {"ChTest-Ch1", "Ch2", pwr_cClass_AArray100, LDH__SUCCESS, 1, pwr_cNOid,
       pwr_cNOid},
      {"ChTest-Ch1-Ch2", "Ch3", pwr_cClass_AArray100, LDH__SUCCESS, 1,
       pwr_cNOid, pwr_cNOid},
      {"ChTest-Ch1-Ch2-Ch3", "Ch4", pwr_cClass_AArray100, LDH__SUCCESS, 1,
       pwr_cNOid, pwr_cNOid},
      {"ChTest-Ch1-Ch2-Ch3-Ch4", "Ch5", pwr_cClass_AArray100, LDH__SUCCESS, 1,
       pwr_cNOid, pwr_cNOid},
      {"ChTest-Ch1-Ch2-Ch3-Ch4-Ch5", "Ch6", pwr_cClass_AArray100, LDH__SUCCESS,
       1, pwr_cNOid, pwr_cNOid},
      {"ChTest-Ch1-Ch2-Ch3-Ch4-Ch5-Ch6", "Ch7", pwr_cClass_AArray100,
       LDH__SUCCESS, 1, pwr_cNOid, pwr_cNOid},
      {"ChTest-Ch1-Ch2-Ch3-Ch4-Ch5-Ch6-Ch7", "Ch8", pwr_cClass_AArray100,
       LDH__SUCCESS, 1, pwr_cNOid, pwr_cNOid},
      {"ChTest-Ch1-Ch2-Ch3-Ch4-Ch5-Ch6-Ch7-Ch8", "Ch9", pwr_cClass_AArray100,
       LDH__SUCCESS, 1, pwr_cNOid, pwr_cNOid},
      {"ChTest-Ch1-Ch2-Ch3-Ch4-Ch5-Ch6-Ch7-Ch8-Ch9", "Ch10",
       pwr_cClass_AArray100, LDH__SUCCESS, 1, pwr_cNOid, pwr_cNOid},
      {"ChTest-Ch1-Ch2-Ch3-Ch4-Ch5-Ch6-Ch7-Ch8-Ch9-Ch10", "Ch11",
       pwr_cClass_AArray100, LDH__SUCCESS, 1, pwr_cNOid, pwr_cNOid},
      {"ChTest-Ch1-Ch2-Ch3-Ch4-Ch5-Ch6-Ch7-Ch8-Ch9-Ch10-Ch11", "Ch12",
       pwr_cClass_AArray100, LDH__SUCCESS, 1, pwr_cNOid, pwr_cNOid},
      {"ChTest-Ch1-Ch2-Ch3-Ch4-Ch5-Ch6-Ch7-Ch8-Ch9-Ch10-Ch11-Ch12", "",
       pwr_cClass_AArray100, LDH__NO_CHILD, 0, pwr_cNOid, pwr_cNOid}};
  pwr_tAName cname;
...
void wa_ldhtest::GetParent(void) {
  sGetParent d[] = {{"RootObject", LDH__NO_PARENT},
  ...
  for (unsigned int i = 0; i < sizeof(d) / sizeof(d[0]); i++) {
    ...
    if (ODD(m_sts)) {
      m_sts = ldh_ObjidToName(m_ldhses, poid, ldh_eName_Hierarchy, pname,
                              sizeof(pname), &size);
      if (EVEN(m_sts)) {
...
void wa_ldhtest::GetPreviousSibling(void) {
  ...
  for (unsigned int i = 0; i < sizeof(d) / sizeof(d[0]); i++) {
    ...
    if (ODD(m_sts)) {
      ...
      if (EVEN(m_sts)) {
        m_log->log('E', "GetPreviousSibling, ldh_NameToObjid", d[i].name,
                   m_sts);
        return;
      }
...
void wa_ldhtest::NameToAttrRef(void) {
  sNameToAttrRef d[] = {
      ...
      {"RootObject-Child1-P1.CircuitBreaker.NotTripped",
       "RootObject-Child1-P1.CircuitBreaker.NotTripped", LDH__SUCCESS},
...
void wa_ldhtest::AttrRefToName(void) {
  sAttrRefToName d[] = {
      ...
      {"RootObject-Child1.Photo", cdh_mName_object | cdh_mName_attribute,
       "Child1.Photo", LDH__SUCCESS},
      {"RootObject-Child1.Photo", cdh_mName_volumeStrict,
       "VolPwrtest02:RootObject-Child1.Photo", LDH__SUCCESS},
      {"RootObject-Child1.Photo", cdh_mName_pathStrict,
       "RootObject-Child1.Photo", LDH__SUCCESS},
      ...
      {"RootObject-Child1-P1.CircuitBreaker.NotTripped", cdh_mName_attribute,
       ".CircuitBreaker.NotTripped", LDH__SUCCESS},
      {"RootObject-Child1-P1.CircuitBreaker.NotTripped",
      ...
      {"RootObject-Child1-P1.CircuitBreaker.NotTripped.Photo", cdh_mNName,
       "RootObject-Child1-P1.CircuitBreaker.NotTripped.Photo", LDH__SUCCESS},
      ...
      {"RootObject-Child1-P1.CircuitBreaker.NotTripped.Photo",
       cdh_mName_attribute, ".CircuitBreaker.NotTripped.Photo", LDH__SUCCESS},
      {"RootObject-Child1-P1.CircuitBreaker.NotTripped.Photo",
      ...
      {"RootObject-Child1-A1.Value", cdh_mName_volumeStrict,
       "VolPwrtest02:RootObject-Child1-A1.Value", LDH__SUCCESS},
      {"RootObject-Child1-A1.Value", cdh_mName_pathStrict,
       "RootObject-Child1-A1.Value", LDH__SUCCESS},
      {"RootObject-Child1-A1.Value[99]", cdh_mNName,
       "RootObject-Child1-A1.Value[99]", LDH__SUCCESS},
      {"RootObject-Child1-A1.Value[99]", cdh_mName_object, "A1", LDH__SUCCESS},
      {"RootObject-Child1-A1.Value[99]", cdh_mName_attribute, ".Value[99]",
       LDH__SUCCESS},
      ...
      {"RootObject-Child1-A1.Value[99]", cdh_mName_volumeStrict,
       "VolPwrtest02:RootObject-Child1-A1.Value[99]", LDH__SUCCESS},
...
void wa_ldhtest::AttrArefToObjectAref(void) {
  sAttrArefToObjectAref d[] = {
      ...
      {"RootObject-Child1-P1.CircuitBreaker.NotTripped",
       "RootObject-Child1-P1.CircuitBreaker", LDH__SUCCESS}};
  ...
  for (unsigned int i = 0; i < sizeof(d) / sizeof(d[0]); i++) {
    ...
    if (ODD(m_sts)) {
      m_sts = ldh_AttrRefToName(m_ldhses, &oaref, cdh_mName_pathStrict, &aname,
                                &size);
      if (EVEN(m_sts)) {
...
void wa_ldhtest::GetClassList(void) {
  ...
  for (unsigned int i = 0; i < sizeof(d) / sizeof(d[0]); i++) {
    ...
    if (ODD(m_sts)) {
      m_sts = ldh_ObjidToName(m_ldhses, oid, ldh_eName_Hierarchy, oname,
                              sizeof(oname), &size);
      if (EVEN(m_sts)) {
      ...
      if (strcmp(oname, d[i].name) != 0) {
        m_log->vlog('E', "GetClassList, wrong object, %s != %s", d[i].name,
                    oname);
        return;
      }
    }
...
void wa_ldhtest::GetNextObject(void) {
  ...
  for (unsigned int i = 0; i < sizeof(d) / sizeof(d[0]); i++) {
    ...
    if (ODD(m_sts)) {
      m_sts = ldh_ObjidToName(m_ldhses, nextoid, ldh_eName_Hierarchy, nextname,
                              sizeof(nextname), &size);
      if (EVEN(m_sts)) {
        m_log->log('E', "GetNextObject ldh_ObjidToName", d[i].next, m_sts);
        return;
      }
      if (strcmp(nextname, d[i].next) != 0) {
        m_log->vlog('E', "GetNextObject, wrong object, %s != %s", d[i].next,
                    nextname);
        return;
      }
    }
...
void wa_ldhtest::GetNextAttrRef(void) {
  sGetNextAttrRef d[] = {
      ...
      {pwr_cClass_Pwrt02_Component, "Test02-First-Comp1",
       "Test02-First-C1.Super", LDH__SUCCESS},
      {pwr_cClass_Pwrt02_Component, "Test02-First-C1.Super",
       "Test02-First-M1.Super", LDH__SUCCESS},
      {pwr_cClass_Pwrt02_Component, "Test02-First-M1.Super",
       "Test02-First-M1.Contactor1.Super", LDH__SUCCESS},
      {pwr_cClass_Pwrt02_Component, "Test02-First-M1.Contactor1.Super",
       "Test02-First-R1.Super", LDH__SUCCESS},
      {pwr_cClass_Pwrt02_Component, "Test02-First-R1.Super",
       "Test02-First-R1.Motors[0].Super", LDH__SUCCESS},
      {pwr_cClass_Pwrt02_Component, "Test02-First-R1.Motors[0].Super",
       "Test02-First-R1.Motors[0].Contactor2.Super", LDH__SUCCESS},
      {pwr_cClass_Pwrt02_Component,
       "Test02-First-R1.Motors[0].Contactor2.Super",
       "Test02-First-R1.Motors[1].Super", LDH__SUCCESS},
      {pwr_cClass_Pwrt02_Component, "Test02-First-R1.Motors[1].Super",
       "Test02-First-R1.Motors[1].Contactor1.Super", LDH__SUCCESS},
      {pwr_cClass_Pwrt02_Component,
       "Test02-First-R1.Motors[1].Contactor1.Super",
       "Test02-First-R1.Motors[2].Super", LDH__SUCCESS},
      {pwr_cClass_Pwrt02_Component, "Test02-First-R1.Motors[2].Super",
       "Test02-First-R1.Motors[2].Contactor2.Super", LDH__SUCCESS},
      {pwr_cClass_Pwrt02_Component,
       "Test02-First-R1.Motors[2].Contactor2.Super",
       "Test02-First-R1.Motors[3].Super", LDH__SUCCESS},
      {pwr_cClass_Pwrt02_Component, "Test02-First-R1.Motors[3].Super",
       "Test02-First-R1.Motors[3].Contactor1.Super", LDH__SUCCESS},
      {pwr_cClass_Pwrt02_Component,
       "Test02-First-R1.Motors[3].Contactor1.Super",
       "Test02-First-R1.Motors[4].Super", LDH__SUCCESS},
      {pwr_cClass_Pwrt02_Component, "Test02-First-R1.Motors[4].Super",
       "Test02-First-R1.Motors[4].Contactor2.Super", LDH__SUCCESS},
      {pwr_cClass_Pwrt02_Component,
       "Test02-First-R1.Motors[4].Contactor2.Super",
       "Test02-First-R1.Motors[5].Super", LDH__SUCCESS},
      {pwr_cClass_Pwrt02_Component, "Test02-First-R1.Motors[5].Super",
       "Test02-First-R1.Motors[5].Contactor1.Super", LDH__SUCCESS},
      {pwr_cClass_Pwrt02_Component,
       "Test02-First-R1.Motors[5].Contactor1.Super",
       "Test02-First-R1.Motors[6].Super", LDH__SUCCESS},
      {pwr_cClass_Pwrt02_Component, "Test02-First-R1.Motors[6].Super",
       "Test02-First-R1.Motors[6].Contactor2.Super", LDH__SUCCESS},
      {pwr_cClass_Pwrt02_Component,
       "Test02-First-R1.Motors[6].Contactor2.Super",
       "Test02-First-R1.Motors[7].Super", LDH__SUCCESS},
      {pwr_cClass_Pwrt02_Component, "Test02-First-R1.Motors[7].Super",
       "Test02-First-R1.Motors[7].Contactor1.Super", LDH__SUCCESS},
      {pwr_cClass_Pwrt02_Component,
       "Test02-First-R1.Motors[7].Contactor1.Super",
       "Test02-First-R1.Motors[8].Super", LDH__SUCCESS},
      {pwr_cClass_Pwrt02_Component, "Test02-First-R1.Motors[8].Super",
       "Test02-First-R1.Motors[8].Contactor1.Super", LDH__SUCCESS},
      {pwr_cClass_Pwrt02_Component,
       "Test02-First-R1.Motors[8].Contactor1.Super",
       "Test02-First-R1.Motors[9].Super", LDH__SUCCESS},
      {pwr_cClass_Pwrt02_Component, "Test02-First-R1.Motors[9].Super",
       "Test02-First-R1.Motors[9].Contactor2.Super", LDH__SUCCESS},
      {pwr_cClass_Pwrt02_Component,
       "Test02-First-R1.Motors[9].Contactor2.Super", "", LDH__NONEXT}};
  ...
  for (unsigned int i = 0; i < sizeof(d) / sizeof(d[0]); i++) {
    ...
    if (ODD(m_sts)) {
      m_sts =
          ldh_AttrRefToName(m_ldhses, &nextaref, cdh_mNName, &nextname, &size);
      if (EVEN(m_sts)) {
        m_log->log('E', "GetNextAttrRef gdh_AttrrefToName", d[i].next, m_sts);
        return;
      }
      if (strcmp(nextname, d[i].next) != 0) {
        m_log->vlog('E', "GetNextAttrRef, wrong object, %s != %s", d[i].next,
                    nextname);
        return;
      }
    }
...
void wa_ldhtest::ClassNameToId(void) {
  ...
  for (unsigned int i = 0; i < sizeof(d) / sizeof(d[0]); i++) {
    ...
    if (ODD(m_sts)) {
      if (d[i].cid != cid) {
        m_log->vlog('E', "ClassNameToId, wrong cid %s, %d != %d", d[i].cname,
                    d[i].cid, cid);
        return;
      }
    }
  ...
  for (unsigned int i = 0; i < sizeof(d) / sizeof(d[0]); i++) {
    ...
    if (ODD(m_sts)) {
      if (strcmp(d[i].cname, cname) != 0) {
        m_log->vlog('E', "ClassIdToName, wrong name, %s != %s", d[i].cname,
                    cname);
        return;
      }
    }
...
void wa_ldhtest::GetMaskBitDef(void) {
  sGetMaskBitDef d[] = {
      ...
      {"CVolPwrtest02:Type-Pwrt02_MotorMask", "Off", 1, "Running", 8,
       LDH__SUCCESS}};
...
void wa_ldhtest::GetObjectClass(void) {
  ...
  for (unsigned int i = 0; i < sizeof(d) / sizeof(d[0]); i++) {
    ...
    if (ODD(m_sts)) {
      if (d[i].cid != cid) {
        m_log->vlog('E', "GetObjectClass, object class doesn't match, idx %d",
                    i);
        return;
      }
    }
...
void wa_ldhtest::GetAttrRefTid(void) {
  sGetAttrRefTid d[] = {
      ...
      {"Test02-Ldh-P1.CircuitBreaker.NotTripped.ActualValue", pwr_eType_Boolean,
       "", LDH__SUCCESS},
...
void wa_ldhtest::GetNextVolume(void) {
  sGetNextVolume d[] = {{"_V0.254.254.210", "_V0.0.0.1", LDH__SUCCESS},
  ...
  for (unsigned int i = 0; i < sizeof(d) / sizeof(d[0]); i++) {
    ...
    if (strcmp(d[i].nextvid, "") != 0) {
      ...
      if (EVEN(m_sts)) {
        m_log->log('E', "GetNextVolume, cdh_StringToVolumeId", d[i].nextvid,
                   m_sts);
        return;
      }
    }
    ...
    if (ODD(m_sts)) {
      if (nvid != nextvid) {
        ...
        m_log->vlog(
            'E', "GetNextVolume, wrong volume %s != %s, idx %d",
            cdh_VolumeIdToString(nvid_str, sizeof(nvid_str), nvid, 0, 0),
            cdh_VolumeIdToString(nextvid_str, sizeof(nextvid_str), nextvid, 0,
                                 0),
            i);
        return;
      }
...
void wa_ldhtest::GetVolumeClass(void) {
  ...
  for (unsigned int i = 0; i < sizeof(d) / sizeof(d[0]); i++) {
    ...
    if (ODD(m_sts)) {
      if (d[i].cid != cid) {
        m_log->vlog('E', "GetVolumeClass, class doesn't match %s, idx %d",
                    d[i].name, i);
        return;
      }
    }
...
void wa_ldhtest::GetVidInfo(void) {
  ...
  for (unsigned int i = 0; i < sizeof(d) / sizeof(d[0]); i++) {
    ...
    if (ODD(m_sts)) {
      if (vid != info.Volume || d[i].cid != info.Class) {
...
void wa_ldhtest::GetVolumeInfo(void) {
  ...
  if (info.Volume != m_vid || info.Class != pwr_eClass_RootVolume) {
...
void wa_ldhtest::OpenSession(void) {
  sOpenSession d[] = {{ldh_eAccess_ReadWrite, ldh_eUtility_Pwr},
...
void wa_ldhtest::CopyObject(void) {
  sCopyObject d[] = {
      ...
      {"Test02-First-Dv1", "Test02-First-Tmp", ldh_eDest_IntoFirst, "Dv1",
       LDH__SUCCESS},
      {"Test02-First-Dv2", "Test02-First-Tmp", ldh_eDest_IntoLast, "Dv2",
       LDH__SUCCESS},
      {"Test02-First-Aggr1", "Test02-First-Tmp", ldh_eDest_IntoLast, "Aggr1",
       LDH__SUCCESS},
      {"Test02-First-Aggr2", "Test02-First-Tmp", ldh_eDest_IntoLast, "Aggr2",
       LDH__SUCCESS},
      {"Test02-First-R1", "Test02-First-Tmp", ldh_eDest_IntoLast, "R1",
       LDH__SUCCESS},
      {"Test02-First-C1", "Test02-First-Tmp", ldh_eDest_IntoLast, "C1",
       LDH__SUCCESS},
      {"Test02-First-M1", "Test02-First-Tmp", ldh_eDest_IntoLast, "M1",
       LDH__SUCCESS}};
  ...
  for (unsigned int i = 0; i < sizeof(d) / sizeof(d[0]); i++) {
    ...
    m_sts =
        ldh_CopyObject(m_ldhses, &d[i].oid, d[i].name, soid, doid, d[i].dtype);
    if (EVEN(m_sts)) {
...
void wa_ldhtest::CopyObjectTrees(void) {
  ...
  for (unsigned int i = 0; i < sizeof(d) / sizeof(d[0]); i++) {
    ...
    m_sts = ldh_NameToObjid(m_ldhses, &doid, d[i].dest);
    if (EVEN(m_sts)) {
      m_log->log('E', "CopyObjectTrees, dest ldh_NameToObjid", d[i].dest,
                 m_sts);
      return;
    }
...
void wa_ldhtest::CreateVolume(void) {
  sCreateVolume d[] = {
      {"CVolTest1", "_V0.0.44.44", pwr_eClass_ClassVolume, ldh_eVolRep_Wbl,
       LDH__NOSUCHVOL} // Error status for not configured volume?
  };
...
void wa_ldhtest::GetObjectPar(void) {
  sGetObjectPar d[] = {
      ...
      {"Test02-Pwrwb-L1.Description", 3, 0, 0,
       "BaseLevelSensor used for python tests", LDH__SUCCESS},
      ...
      {"Test02-Pwrwb-Values.String80", 3, 0, 0,
       "Why don't you have wings to fly with?", LDH__SUCCESS},
      {"Test02-Pwrwb-Values.Time", 3, 0, 0, "15-MAY-2020 08:27:50.50",
       LDH__SUCCESS},
      {"Test02-Pwrwb-Values.DeltaTime", 3, 0, 0, "27 8:27:50.05", LDH__SUCCESS},
      {"Test02-Pwrwb-Values.Objid", 3, 0, 0, "VolPwrtest02:Test02-Pwrwb-Values",
       LDH__SUCCESS},
      {"Test02-Pwrwb-Values.AttrRef", 3, 0, 0,
       "VolPwrtest02:Test02-Pwrwb-Values.AttrRef", LDH__SUCCESS},
      ...
      {"Test02-Pwrwb-Values.Float64Array[4]", 2, 0, 4444.4444, "",
       LDH__SUCCESS},
      {"Test02-Pwrwb-Values.String80Array[4]", 3, 0, 0,
       "Why don't you have wings to fly with?", LDH__SUCCESS},
      {"Test02-Pwrwb-Values.TimeArray[4]", 3, 0, 0, "15-MAY-2020 08:27:50.50",
       LDH__SUCCESS},
      {"Test02-Pwrwb-Values.DeltaTimeArray[4]", 3, 0, 0, "27 8:27:50.05",
       LDH__SUCCESS},
      {"Test02-Pwrwb-Values.ObjidArray[4]", 3, 0, 0,
       "VolPwrtest02:Test02-Pwrwb-Values", LDH__SUCCESS},
      {"Test02-Pwrwb-Values.AttrRefArray[4]", 3, 0, 0,
       "VolPwrtest02:Test02-Pwrwb-Values.AttrRefArray[4]", LDH__SUCCESS}};
  ...
  for (unsigned int i = 0; i < sizeof(d) / sizeof(d[0]); i++) {
    ...
    s = strchr(d[i].aname, '.');
    m_sts =
        ldh_GetObjectPar(m_ldhses, aref.Objid, "RtBody", s + 1, &buff, &size);
    if (EVEN(m_sts)) {
    ...
    case 1:
      ...
      case pwr_eType_Boolean: {
        ...
        if ((pwr_tBoolean)d[i].ival != *(pwr_tBoolean *)(buff + offs)) {
          m_log->vlog('E', "GetObjectPar, %s, value doesn't match %d != %d",
                      d[i].aname, d[i].ival, *(pwr_tBoolean *)(buff + offs));
          return;
        }
        break;
      }
      case pwr_eType_Int8: {
        ...
        if ((pwr_tInt8)d[i].ival != *(pwr_tInt8 *)(buff + offs)) {
          m_log->vlog('E', "GetObjectPar, %s, value doesn't match %d != %d",
                      d[i].aname, d[i].ival, *(pwr_tInt8 *)(buff + offs));
          return;
        }
        break;
      }
      case pwr_eType_Int16: {
        ...
        if ((pwr_tInt16)d[i].ival != *(pwr_tInt16 *)(buff + offs)) {
          m_log->vlog('E', "GetObjectPar, %s, value doesn't match %d != %d",
                      d[i].aname, d[i].ival, *(pwr_tInt16 *)(buff + offs));
          return;
        }
        break;
      }
      case pwr_eType_Int32: {
        ...
        if ((pwr_tInt32)d[i].ival != *(pwr_tInt32 *)(buff + offs)) {
          m_log->vlog('E', "GetObjectPar, %s, value doesn't match %d != %d",
                      d[i].aname, d[i].ival, *(pwr_tInt32 *)(buff + offs));
          return;
        }
        break;
      }
      case pwr_eType_Int64: {
        ...
        if ((pwr_tInt64)d[i].ival != *(pwr_tInt64 *)(buff + offs)) {
          m_log->vlog('E', "GetObjectPar, %s, value doesn't match %d != %d",
                      d[i].aname, d[i].ival, *(pwr_tInt64 *)(buff + offs));
          return;
        }
        break;
      }
      case pwr_eType_UInt8: {
        ...
        if ((pwr_tUInt8)d[i].ival != *(pwr_tUInt8 *)(buff + offs)) {
          m_log->vlog('E', "GetObjectPar, %s, value doesn't match %d != %d",
                      d[i].aname, d[i].ival, *(pwr_tUInt8 *)(buff + offs));
          return;
        }
        break;
      }
      case pwr_eType_UInt16: {
        ...
        if ((pwr_tUInt16)d[i].ival != *(pwr_tUInt16 *)(buff + offs)) {
          m_log->vlog('E', "GetObjectPar, %s, value doesn't match %d != %d",
                      d[i].aname, d[i].ival, *(pwr_tUInt16 *)(buff + offs));
          return;
        }
        break;
      }
      case pwr_eType_UInt32: {
        ...
        if ((pwr_tUInt32)d[i].ival != *(pwr_tUInt32 *)(buff + offs)) {
          m_log->vlog('E', "GetObjectPar, %s, value doesn't match %d != %d",
                      d[i].aname, d[i].ival, *(pwr_tUInt32 *)(buff + offs));
          return;
        }
        break;
      }
      case pwr_eType_UInt64: {
        ...
        if ((pwr_tUInt64)d[i].ival != *(pwr_tUInt64 *)(buff + offs)) {
          m_log->vlog('E', "GetObjectPar, %s, value doesn't match %d != %d",
                      d[i].aname, d[i].ival, *(pwr_tUInt64 *)(buff + offs));
          return;
        }
        break;
      }
    ...
    case 2:
      ...
      case pwr_eType_Float32: {
        ...
        if (fabs((pwr_tFloat32)d[i].fval - *(pwr_tFloat32 *)(buff + offs)) >
            FLT_EPSILON * 1000) {
          m_log->vlog('E', "GetObjectPar, %s, value doesn't match %f != %f",
                      d[i].aname, d[i].fval, *(pwr_tFloat32 *)(buff + offs));
          return;
        }
        break;
      }
      case pwr_eType_Float64: {
        ...
        if (fabs((pwr_tFloat64)d[i].fval - *(pwr_tFloat64 *)(buff + offs)) >
            FLT_EPSILON * 10000) {
          m_log->vlog('E', "GetObjectPar, %s, value doesn't match %f != %f",
                      d[i].aname, d[i].fval, *(pwr_tFloat64 *)(buff + offs));
          return;
        }
        break;
      }
    ...
    case 3:
      ...
      case pwr_eType_String: {
        ...
        if (strcmp(d[i].sval, (buff + offs)) != 0) {
          m_log->vlog('E', "GetObjectPar, %s, value doesn't match %s != %s",
                      d[i].aname, d[i].sval, (buff + offs));
          return;
        }
        break;
      }
      case pwr_eType_Time: {
        ...
        time_AtoAscii((pwr_tTime *)(buff + offs), time_eFormat_DateAndTime,
                      timstr, sizeof(timstr));
        if (strcmp(d[i].sval, timstr) != 0) {
          m_log->vlog('E', "GetObjectPar, %s, value doesn't match %s != %s",
                      d[i].aname, d[i].sval, timstr);
          return;
        }
        break;
      }
      case pwr_eType_DeltaTime: {
        char timstr[40];
        offs = index * sizeof(pwr_tTime);
        time_DtoAscii((pwr_tDeltaTime *)(buff + offs), 1, timstr,
                      sizeof(timstr));
        if (strcmp(d[i].sval, timstr) != 0) {
          m_log->vlog('E', "GetObjectPar, %s, value doesn't match %s != %s",
                      d[i].aname, d[i].sval, timstr);
      ...
      case pwr_eType_Objid: {
        ...
        m_sts = ldh_ObjidToName(m_ldhses, *(pwr_tOid *)(buff + offs),
                                ldh_eName_VolPath, oname, sizeof(oname), &size);
        if (strcmp(d[i].sval, oname) != 0) {
          m_log->vlog('E', "GetObjectPar, %s, value doesn't match %s != %s",
                      d[i].aname, d[i].sval, oname);
          return;
        }
        break;
      }
      case pwr_eType_AttrRef: {
        ...
        m_sts = ldh_AttrRefToName(m_ldhses, (pwr_tAttrRef *)(buff + offs),
                                  cdh_mName_volumeStrict, &aname, &size);
        if (strcmp(d[i].sval, aname) != 0) {
          m_log->vlog('E', "GetObjectPar, %s, value doesn't match %s != %s",
                      d[i].aname, d[i].sval, aname);
          return;
        }
        break;
      }
...
void wa_ldhtest::SetObjectPar(void) {
  sSetObjectPar d[] = {
      ...
      {"Test02-Pwrwb-SetValues.String80", 3, 0, 0,
       "Why don't you have wings to fly with?", LDH__SUCCESS},
      {"Test02-Pwrwb-SetValues.Time", 3, 0, 0, "15-MAY-2020 08:27:50.50",
       LDH__SUCCESS},
      {"Test02-Pwrwb-SetValues.DeltaTime", 3, 0, 0, "27 8:27:50.05",
       LDH__SUCCESS},
      {"Test02-Pwrwb-SetValues.Objid", 3, 0, 0,
       "VolPwrtest02:Test02-Pwrwb-SetValues", LDH__SUCCESS},
      {"Test02-Pwrwb-SetValues.AttrRef", 3, 0, 0,
       "VolPwrtest02:Test02-Pwrwb-SetValues.AttrRef", LDH__SUCCESS}};
  ...
  for (unsigned int i = 0; i < sizeof(d) / sizeof(d[0]); i++) {
    ...
    int rsize;
    m_sts =
        ldh_GetObjectPar(m_ldhses, aref.Objid, "RtBody", s + 1, &rbuff, &rsize);
    if (EVEN(m_sts)) {
      m_log->log('E', "SetObjectPar", d[i].aname, m_sts);
      return;
    }
...
void wa_ldhtest::Init(void) {
  ...
  m_sts = ldh_OpenSession(&m_ldhses, m_volctx, ldh_eAccess_ReadWrite,
                          ldh_eUtility_Pwr);
  if (EVEN(m_sts)) {
...
// Destructor
wa_ldhtest::~wa_ldhtest() { delete m_log; }
