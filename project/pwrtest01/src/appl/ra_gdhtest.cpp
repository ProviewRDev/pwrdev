...
pwr_tStatus ra_gdhtest::check_object(pwr_tOid oid) {
  ...
  if (ODD(sts)) {
    int found = 0;
    for (sts = gdh_GetChild(p, &child); ODD(sts);
...
void ra_gdhtest::ObjidToName(void) {
  sObjidToName d[] = {
      ...
      {"Test01c-Gdh-LongName90123456789012345678901", HASH__SUCCESS,
       HASH__SUCCESS, pwr_cNOid},
      {"Test01c-Gdh-TooLongName234567890123456789012", CDH__SEGLEN, 0,
       pwr_cNOid}};
  pwr_tOName oname;
...
void ra_gdhtest::ObjidToPointer(void) {
  sObjidToPointer d[] = {
      {"Test01c-Gdh-Av1", offsetof(pwr_sClass_Av, Description),
       pwr_eType_String, 80, "Av with value 222", HASH__SUCCESS, pwr_cNOid},
      {"Test01c-Gdh-Dv1", offsetof(pwr_sClass_Dv, Description),
       pwr_eType_String, 80, "Dv with value true", HASH__SUCCESS, pwr_cNOid},
      {"Test01c-Gdh-W1", offsetof(pwr_sClass_Pwrt01_WriteClass, Value),
       pwr_eType_Float32, 4, "9", HASH__SUCCESS, pwr_cNOid}};
  char value[80];
  char *p;
  ...
  for (unsigned int i = 0; i < sizeof(d) / sizeof(d[0]); i++) {
    m_sts = gdh_NameToObjid(d[i].name, &d[i].oid);
    if (EVEN(m_sts)) {
      m_log->log('E', "ObjidToPointer, NameToObjid wrong sts", d[i].name,
                 m_sts);
      return;
    }
    ...
    if (m_sts != d[i].sts) {
      ...
      m_sts = gdh_AttrStringToValue(d[i].type, d[i].valuestr, value,
                                    sizeof(value), d[i].size);
      if (EVEN(m_sts)) {
...
void ra_gdhtest::MountObjidToPointer(void) {
  sObjidToPointer d[] = {{"Test01c-Gdh-PlcMountTest",
                          offsetof(pwr_sClass_MountObject, Description),
                          pwr_eType_String, 80, "Mounting test object",
                          HASH__SUCCESS, pwr_cNOid}};
  char value[80];
  char *p;
  pwr_tOid oid;
  ...
  for (m_sts = gdh_GetClassList(pwr_eClass_MountObject, &oid); ODD(m_sts);
...
void ra_gdhtest::AttrRefToPointer(void) {
  sAttrRefToPointer d[] = {
      {"Test01c-Gdh-Av1.Description", pwr_eType_String, 80, "Av with value 222",
       HASH__SUCCESS},
      {"Test01c-Gdh-Dv1.Description", pwr_eType_String, 80,
       "Dv with value true", HASH__SUCCESS},
  ...
  for (unsigned int i = 0; i < sizeof(d) / sizeof(d[0]); i++) {
    ...
    if (m_sts != d[i].sts) {
      ...
      case pwr_eType_Float32:
        if (fabs(*(pwr_tFloat32 *)value - *(pwr_tFloat32 *)p) >
            FLT_EPSILON * 100) {
          m_log->log('E', "AttrRefToPointer, wrong value", d[i].name);
          return;
        }
...
void ra_gdhtest::CreateObject(void) {
  sCreateObject d[] = {
      ...
      {"pwrNode-Test-H3-ƒ≈÷‰Âˆ", pwr_cClass_PlantHier, HASH__SUCCESS,
       pwr_cNOid},
      {"pwrNode-Test-H3-LongName90123456789012345678901", pwr_cClass_PlantHier,
       HASH__SUCCESS, pwr_cNOid},
      {"pwrNode-Test-H3-TooLongName234567890123456789012", pwr_cClass_PlantHier,
       CDH__SEGLEN, pwr_cNOid},
      {"pwrNode-Test-H3-Invalid#Name", pwr_cClass_PlantHier, CDH__INVCHAR,
       pwr_cNOid},
      {"pwrNode-Test-H3-H4-NoParent", pwr_cClass_PlantHier, GDH__BADPARENT,
       pwr_cNOid}};
  pwr_tOName oname;
  ...
  for (unsigned int i = 0; i < sizeof(d) / sizeof(d[0]); i++) {
    m_sts = gdh_CreateObject(d[i].name, d[i].cid, 0, &d[i].oid, pwr_cNOid, 0,
                             pwr_cNOid);
    if (m_sts != d[i].sts) {
...
void ra_gdhtest::DeleteObject(void) {
  sDeleteObject d[] = {
      ...
      {"pwrNode-Test-H2-Del3", pwr_cClass_Pwrt01_Roller, HASH__SUCCESS,
       pwr_cNOid},
      {"pwrNode-Test-H2-Del4", pwr_cClass_Pwrt01_Motor, HASH__SUCCESS,
       pwr_cNOid},
      {"pwrNode-Test-H2-Del5", pwr_cClass_Pwrt01_Component, HASH__SUCCESS,
       pwr_cNOid}};
...
void ra_gdhtest::DeleteObjectTree(void) {
  ...
  m_sts = gdh_CreateObject(name, pwr_cClass_AArray100, 0, &oid, pwr_cNOid, 0,
                           pwr_cNOid);
  if (EVEN(m_sts)) {
  ...
  for (int i = 0; i < 10; i++) {
    ...
    m_sts = gdh_CreateObject(cname, pwr_cClass_AArray100, 0, &coid, pwr_cNOid,
                             0, pwr_cNOid);
    if (EVEN(m_sts)) {
...
void ra_gdhtest::MoveObject(void) {
  ...
  m_sts = gdh_CreateObject(name, pwr_cClass_PlantHier, 0, &p1, pwr_cNOid, 0,
                           pwr_cNOid);
  if (EVEN(m_sts)) {
    m_log->log('E', "MoveObject, error in gdh_CreateObject", m_sts);
    return;
  ...
  m_sts = gdh_CreateObject(name, pwr_cClass_PlantHier, 0, &p2, pwr_cNOid, 0,
                           pwr_cNOid);
  if (EVEN(m_sts)) {
    m_log->log('E', "MoveObject, error in gdh_CreateObject", m_sts);
    return;
  ...
  for (int i = 0; i < 100; i++) {
    ...
    m_sts = gdh_CreateObject(cname, pwr_cClass_AArray100, 0, &c[i], pwr_cNOid,
                             0, pwr_cNOid);
    if (EVEN(m_sts)) {
      m_log->log('E', "MoveObject, error in gdh_CreateObject", m_sts);
      return;
...
void ra_gdhtest::GetChild(void) {
  sGetChild d[] = {
      {"RootObject", "Child1", pwr_cClass_PlantHier, HASH__SUCCESS, 0,
       pwr_cNOid, pwr_cNOid},
      {"RootObject-ChildLess", "", pwr_cClass_PlantHier, GDH__NO_CHILD, 0,
       pwr_cNOid, pwr_cNOid},
      {"pwrNode-ChTest", "Ch1", pwr_cClass_PlantHier, HASH__SUCCESS, 1,
       pwr_cNOid, pwr_cNOid},
      {"pwrNode-ChTest-Ch1", "Ch2", pwr_cClass_AArray100, HASH__SUCCESS, 1,
       pwr_cNOid, pwr_cNOid},
      {"pwrNode-ChTest-Ch1-Ch2", "Ch3", pwr_cClass_AArray100, HASH__SUCCESS, 1,
       pwr_cNOid, pwr_cNOid},
      {"pwrNode-ChTest-Ch1-Ch2-Ch3", "Ch4", pwr_cClass_AArray100, HASH__SUCCESS,
       1, pwr_cNOid, pwr_cNOid},
      {"pwrNode-ChTest-Ch1-Ch2-Ch3-Ch4", "Ch5", pwr_cClass_AArray100,
       HASH__SUCCESS, 1, pwr_cNOid, pwr_cNOid},
      {"pwrNode-ChTest-Ch1-Ch2-Ch3-Ch4-Ch5", "Ch6", pwr_cClass_AArray100,
       HASH__SUCCESS, 1, pwr_cNOid, pwr_cNOid},
      {"pwrNode-ChTest-Ch1-Ch2-Ch3-Ch4-Ch5-Ch6", "Ch7", pwr_cClass_AArray100,
       HASH__SUCCESS, 1, pwr_cNOid, pwr_cNOid},
      {"pwrNode-ChTest-Ch1-Ch2-Ch3-Ch4-Ch5-Ch6-Ch7", "Ch8",
       pwr_cClass_AArray100, HASH__SUCCESS, 1, pwr_cNOid, pwr_cNOid},
      {"pwrNode-ChTest-Ch1-Ch2-Ch3-Ch4-Ch5-Ch6-Ch7-Ch8", "Ch9",
       pwr_cClass_AArray100, HASH__SUCCESS, 1, pwr_cNOid, pwr_cNOid},
      {"pwrNode-ChTest-Ch1-Ch2-Ch3-Ch4-Ch5-Ch6-Ch7-Ch8-Ch9", "Ch10",
       pwr_cClass_AArray100, HASH__SUCCESS, 1, pwr_cNOid, pwr_cNOid},
      {"pwrNode-ChTest-Ch1-Ch2-Ch3-Ch4-Ch5-Ch6-Ch7-Ch8-Ch9-Ch10", "Ch11",
       pwr_cClass_AArray100, HASH__SUCCESS, 1, pwr_cNOid, pwr_cNOid},
      {"pwrNode-ChTest-Ch1-Ch2-Ch3-Ch4-Ch5-Ch6-Ch7-Ch8-Ch9-Ch10-Ch11", "Ch12",
       pwr_cClass_AArray100, HASH__SUCCESS, 1, pwr_cNOid, pwr_cNOid},
      {"pwrNode-ChTest-Ch1-Ch2-Ch3-Ch4-Ch5-Ch6-Ch7-Ch8-Ch9-Ch10-Ch11-Ch12", "",
       pwr_cClass_AArray100, GDH__NO_CHILD, 0, pwr_cNOid, pwr_cNOid}};
  pwr_tAName cname;
  pwr_tOid coid, poid;

  m_sts = gdh_CreateObject((char *)"pwrNode-ChTest", pwr_cClass_PlantHier, 0,
                           &poid, pwr_cNOid, 0, pwr_cNOid);
  if (EVEN(m_sts)) {
  ...
  for (unsigned int i = 0; i < sizeof(d) / sizeof(d[0]); i++) {
    ...
    if (d[i].create) {
      m_sts = gdh_CreateObject(cname, d[i].cid, 0, &d[i].coid, pwr_cNOid, 0,
                               pwr_cNOid);
      if (m_sts != d[i].sts) {
...
void ra_gdhtest::GetParent(void) {
  sGetParent d[] = {{"RootObject", GDH__NO_PARENT},
...
void ra_gdhtest::GetAttributeCharacteristics(void) {
  ...
  m_sts =
      gdh_GetAttributeCharacteristics(aname, &a_tid, &a_size, &a_offs, &a_elem);
  if (EVEN(m_sts)) {
  ...
  if (a_offs !=
      offsetof(pwr_sClass_BaseFcPPO3MotorAggr, CircuitBreaker.NotTripped)) {
    m_log->log('E', "GetAttributeCharacteristics offset error");
    return;
  }
  if (a_elem != 1) {
  ...
  if (a_offs != offsetof(pwr_sClass_BaseFcPPO3MotorAggr,
  ...
  for (int i = 0; i < 100; i++) {
    ...
    m_sts = gdh_GetAttributeCharacteristics(aname, &a_tid, &a_size, &a_offs,
                                            &a_elem);
    if (EVEN(m_sts)) {
      m_log->log('E', "GetAttributeCharacteristics", m_sts);
      return;
...
void ra_gdhtest::GetAttributeCharAttrref(void) {
  ...
  for (int i = 0; i < 100; i++) {
    ...
    m_sts =
        gdh_GetAttributeCharAttrref(&aref, &a_tid, &a_size, &a_offs, &a_elem);
    if (EVEN(m_sts)) {
      m_log->log('E', "GetAttributeCharAttrref", m_sts);
      return;
    }
...
void ra_gdhtest::NameToAttrref(void) {
  sNameToAttrRef d[] = {
      ...
      {"RootObject-Child1-P1.CircuitBreaker.NotTripped",
       "RootObject-Child1-P1.CircuitBreaker.NotTripped", GDH__SUCCESS},
      {"RootObject-Child1-A1.Value", "RootObject-Child1-A1.Value",
       GDH__SUCCESS},
      {"RootObject-Child1-A1.Value[99]", "RootObject-Child1-A1.Value[99]",
       GDH__SUCCESS}};
...
void ra_gdhtest::AttrrefToName(void) {
  sAttrRefToName d[] = {
      {"RootObject-Child1.Photo", cdh_mNName, "RootObject-Child1.Photo",
       GDH__SUCCESS},
      ...
      {"RootObject-Child1.Photo", cdh_mName_object | cdh_mName_attribute,
       "Child1.Photo", GDH__SUCCESS},
      {"RootObject-Child1.Photo", cdh_mName_volumeStrict,
       "VolPwrTest01c:RootObject-Child1.Photo", GDH__SUCCESS},
      {"RootObject-Child1.Photo", cdh_mName_pathStrict,
       "RootObject-Child1.Photo", GDH__SUCCESS},
      {"RootObject-Child1-P1.CircuitBreaker.NotTripped", cdh_mNName,
       "RootObject-Child1-P1.CircuitBreaker.NotTripped", GDH__SUCCESS},
      {"RootObject-Child1-P1.CircuitBreaker.NotTripped", cdh_mName_object, "P1",
       GDH__SUCCESS},
      {"RootObject-Child1-P1.CircuitBreaker.NotTripped", cdh_mName_attribute,
       "CircuitBreaker.NotTripped", GDH__SUCCESS},
      {"RootObject-Child1-P1.CircuitBreaker.NotTripped",
       cdh_mName_object | cdh_mName_attribute, "P1.CircuitBreaker.NotTripped",
       GDH__SUCCESS},
      {"RootObject-Child1-P1.CircuitBreaker.NotTripped", cdh_mName_volumeStrict,
       "VolPwrTest01c:RootObject-Child1-P1.CircuitBreaker.NotTripped",
       GDH__SUCCESS},
      {"RootObject-Child1-P1.CircuitBreaker.NotTripped", cdh_mName_pathStrict,
       "RootObject-Child1-P1.CircuitBreaker.NotTripped", GDH__SUCCESS},
      {"RootObject-Child1-P1.CircuitBreaker.NotTripped.Photo", cdh_mNName,
       "RootObject-Child1-P1.CircuitBreaker.NotTripped.Photo", GDH__SUCCESS},
      {"RootObject-Child1-P1.CircuitBreaker.NotTripped.Photo", cdh_mName_object,
       "P1", GDH__SUCCESS},
      {"RootObject-Child1-P1.CircuitBreaker.NotTripped.Photo",
       cdh_mName_attribute, "CircuitBreaker.NotTripped.Photo", GDH__SUCCESS},
      {"RootObject-Child1-P1.CircuitBreaker.NotTripped.Photo",
       cdh_mName_volumeStrict,
       "VolPwrTest01c:RootObject-Child1-P1.CircuitBreaker.NotTripped.Photo",
       GDH__SUCCESS},
      {"RootObject-Child1-P1.CircuitBreaker.NotTripped.Photo",
       cdh_mName_pathStrict,
       "RootObject-Child1-P1.CircuitBreaker.NotTripped.Photo", GDH__SUCCESS},
      {"RootObject-Child1-A1.Value", cdh_mNName, "RootObject-Child1-A1.Value",
       GDH__SUCCESS},
      {"RootObject-Child1-A1.Value", cdh_mName_object, "A1", GDH__SUCCESS},
      {"RootObject-Child1-A1.Value", cdh_mName_attribute, "Value",
       GDH__SUCCESS},
      {"RootObject-Child1-A1.Value", cdh_mName_volumeStrict,
       "VolPwrTest01c:RootObject-Child1-A1.Value", GDH__SUCCESS},
      {"RootObject-Child1-A1.Value", cdh_mName_pathStrict,
       "RootObject-Child1-A1.Value", GDH__SUCCESS},
      {"RootObject-Child1-A1.Value[99]", cdh_mNName,
       "RootObject-Child1-A1.Value[99]", GDH__SUCCESS},
      {"RootObject-Child1-A1.Value[99]", cdh_mName_object, "A1", GDH__SUCCESS},
      {"RootObject-Child1-A1.Value[99]", cdh_mName_attribute, "Value",
       GDH__SUCCESS},
      {"RootObject-Child1-A1.Value[99]",
       cdh_mName_object | cdh_mName_attribute | cdh_mName_index, "A1.Value[99]",
       GDH__SUCCESS},
      {"RootObject-Child1-A1.Value[99]", cdh_mName_volumeStrict,
       "VolPwrTest01c:RootObject-Child1-A1.Value[99]", GDH__SUCCESS},
      {"RootObject-Child1-A1.Value[99]", cdh_mName_pathStrict,
       "RootObject-Child1-A1.Value[99]", GDH__SUCCESS}};
...
void ra_gdhtest::AttrArefToObjectAref(void) {
  sAttrArefToObjectAref d[] = {
      ...
      {"RootObject-Child1-P1.CircuitBreaker.NotTripped",
       "RootObject-Child1-P1.CircuitBreaker", GDH__SUCCESS}};
  ...
  for (unsigned int i = 0; i < sizeof(d) / sizeof(d[0]); i++) {
    ...
    if (ODD(m_sts)) {
      m_sts =
          gdh_AttrrefToName(&oaref, aname, sizeof(aname), cdh_mName_pathStrict);
      if (EVEN(m_sts)) {
        m_log->log('E', "AttrArefToObjectAref", m_sts);
        return;
      }
      if (strcmp(aname, d[i].oname) != 0) {
        m_log->vlog('E', "AttrArefToObjectAref wrong name, %s != %s", aname,
                    d[i].oname);
        return;
      }
    }
...
void ra_gdhtest::ArefANameToAref(void) {
  ...
  m_sts = gdh_NameToAttrref(pwr_cNOid, "RootObject-Child1-P1.CircuitBreaker",
                            &aref);
  if (EVEN(m_sts)) {
    m_log->log('E', "ArefANameToAref", "gdh_NameToAttrref", m_sts);
    return;
...
void ra_gdhtest::AttrValueToString(void) {
  ...
  sValueToString d[] = {
      ...
      {pwr_eType_Time,
       {.t = {1586956789, 500000000}},
       "",
       "15-APR-2020 15:19:49.50"},
      ...
      {pwr_eType_AttrRef,
       {.aref = {{2147483649, 33488587}, 0, 0, 0, 0}},
       "",
       "pwrNode"},
  ...
  for (unsigned int i = 0; i < sizeof(d) / sizeof(d[0]); i++) {
    m_sts =
        gdh_AttrValueToString(d[i].type, 0, &d[i].value, str, sizeof(str), &len,
...
void ra_gdhtest::AttrStringToValue(void) {
  ...
  sStringToValue d[] = {
      ...
      {pwr_eType_DeltaTime,
       {.dt = {54223, 500000000}},
       sizeof(pwr_tDeltaTime),
       "15:03:43.50"},
      {pwr_eType_Objid,
       {.oid = {2147483649, 33488587}},
       sizeof(pwr_tObjid),
       "pwrNode"},
      {pwr_eType_Objid,
       {.oid = {0, 33488587}},
...
void ra_gdhtest::GetPreviousObject(void) {
  ...
  for (unsigned int i = 0; i < sizeof(d) / sizeof(d[0]); i++) {
    ...
    if (ODD(m_sts)) {
      m_sts = gdh_ObjidToName(previousoid, previousname, sizeof(previousname),
                              cdh_mNName);
      if (EVEN(m_sts)) {
        m_log->log('E', "GetPreviousObject gdh_ObjidToName", d[i].previous,
                   m_sts);
        return;
      }
...
void ra_gdhtest::GetClassListAttrRef(void) {
  ...
  for (unsigned int i = 0; i < sizeof(d) / sizeof(d[0]); i++) {
    ...
    if (ODD(m_sts)) {
      ...
      if (EVEN(m_sts)) {
        m_log->log('E', "GetClassListAttrRef gdh_AttrrefToName", d[i].name,
                   m_sts);
        return;
      }
...
void ra_gdhtest::GetNextAttrRef(void) {
  sGetNextAttrRef d[] = {
      ...
      {pwr_cClass_Pwrt01_Component, "Test01c-First-Comp1",
       "Test01c-First-C1.Super", MVOL__SUCCESS},
      {pwr_cClass_Pwrt01_Component, "Test01c-First-C1.Super",
       "Test01c-First-M1.Super", MVOL__SUCCESS},
      {pwr_cClass_Pwrt01_Component, "Test01c-First-M1.Super",
       "Test01c-First-M1.Contactor1.Super", MVOL__SUCCESS},
      {pwr_cClass_Pwrt01_Component, "Test01c-First-M1.Contactor1.Super",
       "Test01c-First-R1.Super", MVOL__SUCCESS},
      {pwr_cClass_Pwrt01_Component, "Test01c-First-R1.Super",
       "Test01c-First-R1.Motors[0].Super", MVOL__SUCCESS},
      {pwr_cClass_Pwrt01_Component, "Test01c-First-R1.Motors[0].Super",
       "Test01c-First-R1.Motors[0].Contactor2.Super", MVOL__SUCCESS},
      {pwr_cClass_Pwrt01_Component,
       "Test01c-First-R1.Motors[0].Contactor2.Super",
       "Test01c-First-R1.Motors[1].Super", MVOL__SUCCESS},
      {pwr_cClass_Pwrt01_Component, "Test01c-First-R1.Motors[1].Super",
       "Test01c-First-R1.Motors[1].Contactor1.Super", MVOL__SUCCESS},
      {pwr_cClass_Pwrt01_Component,
       "Test01c-First-R1.Motors[1].Contactor1.Super",
       "Test01c-First-R1.Motors[2].Super", MVOL__SUCCESS},
      {pwr_cClass_Pwrt01_Component, "Test01c-First-R1.Motors[2].Super",
       "Test01c-First-R1.Motors[2].Contactor2.Super", MVOL__SUCCESS},
      {pwr_cClass_Pwrt01_Component,
       "Test01c-First-R1.Motors[2].Contactor2.Super",
       "Test01c-First-R1.Motors[3].Super", MVOL__SUCCESS},
      {pwr_cClass_Pwrt01_Component, "Test01c-First-R1.Motors[3].Super",
       "Test01c-First-R1.Motors[3].Contactor1.Super", MVOL__SUCCESS},
      {pwr_cClass_Pwrt01_Component,
       "Test01c-First-R1.Motors[3].Contactor1.Super",
       "Test01c-First-R1.Motors[4].Super", MVOL__SUCCESS},
      {pwr_cClass_Pwrt01_Component, "Test01c-First-R1.Motors[4].Super",
       "Test01c-First-R1.Motors[4].Contactor2.Super", MVOL__SUCCESS},
      {pwr_cClass_Pwrt01_Component,
       "Test01c-First-R1.Motors[4].Contactor2.Super",
       "Test01c-First-R1.Motors[5].Super", MVOL__SUCCESS},
      {pwr_cClass_Pwrt01_Component, "Test01c-First-R1.Motors[5].Super",
       "Test01c-First-R1.Motors[5].Contactor1.Super", MVOL__SUCCESS},
      {pwr_cClass_Pwrt01_Component,
       "Test01c-First-R1.Motors[5].Contactor1.Super",
       "Test01c-First-R1.Motors[6].Super", MVOL__SUCCESS},
      {pwr_cClass_Pwrt01_Component, "Test01c-First-R1.Motors[6].Super",
       "Test01c-First-R1.Motors[6].Contactor2.Super", MVOL__SUCCESS},
      {pwr_cClass_Pwrt01_Component,
       "Test01c-First-R1.Motors[6].Contactor2.Super",
       "Test01c-First-R1.Motors[7].Super", MVOL__SUCCESS},
      {pwr_cClass_Pwrt01_Component, "Test01c-First-R1.Motors[7].Super",
       "Test01c-First-R1.Motors[7].Contactor1.Super", MVOL__SUCCESS},
      {pwr_cClass_Pwrt01_Component,
       "Test01c-First-R1.Motors[7].Contactor1.Super",
       "Test01c-First-R1.Motors[8].Super", MVOL__SUCCESS},
      {pwr_cClass_Pwrt01_Component, "Test01c-First-R1.Motors[8].Super",
       "Test01c-First-R1.Motors[8].Contactor1.Super", MVOL__SUCCESS},
      {pwr_cClass_Pwrt01_Component,
       "Test01c-First-R1.Motors[8].Contactor1.Super",
       "Test01c-First-R1.Motors[9].Super", MVOL__SUCCESS},
      {pwr_cClass_Pwrt01_Component, "Test01c-First-R1.Motors[9].Super",
       "Test01c-First-R1.Motors[9].Contactor2.Super", MVOL__SUCCESS},
      {pwr_cClass_Pwrt01_Component,
       "Test01c-First-R1.Motors[9].Contactor2.Super", "", GDH__NO_TYPE}};
  ...
  for (unsigned int i = 0; i < sizeof(d) / sizeof(d[0]); i++) {
    ...
    if (ODD(m_sts)) {
      m_sts =
          gdh_AttrrefToName(&nextaref, nextname, sizeof(nextname), cdh_mNName);
      if (EVEN(m_sts)) {
...
void ra_gdhtest::GetEnumValueDef(void) {
  sGetEnumValueDef d[] = {
      ...
      {"CVolPwrtest01:Type-Pwrt01_MotorEnum", "Off", 0, "On", 1,
       HASH__SUCCESS}};
...
void ra_gdhtest::GetMaskBitDef(void) {
  sGetMaskBitDef d[] = {
      {"pwrb:Type-CardMask1_1", "Channel1", 1, "Channel16", 32768,
       HASH__SUCCESS},
      {"pwrb:Type-CardMask2_1", "Channel17", 1, "Channel32", 32768,
       HASH__SUCCESS},
      {"pwrb:Type-PidModeMask", "Manual", 1, "Cascade", 4, HASH__SUCCESS},
      {"CVolPwrtest01:Type-Pwrt01_MotorMask", "Off", 1, "Running", 8,
       HASH__SUCCESS}};
...
void ra_gdhtest::FWriteObject(void) {
  sFWriteObject d[] = {
      {"Test01c-Gdh-A1", "Test01c-Gdh-A2", "/tmp/a1.dat",
       sizeof(pwr_cClass_AArray100), GDH__SUCCESS, GDH__SUCCESS},
      {"Test01c-Gdh-W1", "Test01c-Gdh-W2", "/tmp/w1.dat",
       sizeof(pwr_cClass_Pwrt01_WriteClass), GDH__SUCCESS, GDH__SUCCESS}};
...
void ra_gdhtest::TranslateRtdbPointer(void) {
  ...
  fp =
      (pwr_tFloat32 *)gdh_TranslateRtdbPointer((unsigned long)avp->ActualValue);
  ...
  bp =
      (pwr_tBoolean *)gdh_TranslateRtdbPointer((unsigned long)dvp->ActualValue);
  if (*bp != 1) {
    m_log->log('E', "TranslateRtdbPointer, value error");
    return;
  }
...
void ra_gdhtest::GetDynamicAttrSize(void) {
  sGetDynamicAttrSize d[] = {
      {"pwrNode-Test-H1-DynSize1", ".Attr", pwr_cClass_Pwrt01_DynAttr, 24,
       24 - sizeof(pwr_tString16), HASH__SUCCESS, pwr_cNOid},
      {"pwrNode-Test-H1-DynSize2", ".Attr", pwr_cClass_Pwrt01_DynAttr, 416,
       416 - sizeof(pwr_tString16), HASH__SUCCESS, pwr_cNOid},
      {"pwrNode-Test-H1-DynSize3", ".Attr", pwr_cClass_Pwrt01_DynAttr, 4016,
       4016 - sizeof(pwr_tString16), HASH__SUCCESS, pwr_cNOid}};
...
void ra_gdhtest::GetAttrRefTid(void) {
  sGetAttrRefTid d[] = {
      ...
      {"Test01c-Gdh-P1.CircuitBreaker.NotTripped.ActualValue",
...
void ra_gdhtest::GetObjectLocation(void) {
  sGetObjectLocation d[] = {{"Test01c-Gdh-A1", 1, HASH__SUCCESS},
...
void ra_gdhtest::GetObjectDLCount(void) {
  sGetObjectDLCount d[] = {
      ...
      {"Test01c-Gdh-Av1.Description", "Test01c-Gdh-Av1.ActualValue", 4, 10,
       HASH__SUCCESS},
  ...
  for (unsigned int i = 0; i < sizeof(d) / sizeof(d[0]); i++) {
    ...
    if (d[i].n2 > 0) {
      ...
      if (EVEN(m_sts)) {
        m_log->log('E', "GetObjectDLCount, gdh_NameToAttrref", d[i].name2,
                   m_sts);
        return;
      }
    }
    ...
    for (unsigned int j = 0; j < d[i].n1; j++) {
      ...
      if (EVEN(m_sts)) {
        m_log->log('E', "GetObjectDLCount, gdh_DLRefObjectInfoAttrref",
                   d[i].name1, m_sts);
        return;
      }
    }
    ...
    for (unsigned int j = 0; j < d[i].n1; j++) {
      ...
      if (EVEN(m_sts)) {
        m_log->log('E', "GetObjectDLCount, gdh_DLUnrefObjectInfo", d[i].name1,
                   m_sts);
        return;
      }
    }
    for (unsigned int j = 0; j < d[i].n2; j++) {
      ...
      if (EVEN(m_sts)) {
        m_log->log('E', "GetObjectDLCount, gdh_DLUnrefObjectInfo", d[i].name2,
                   m_sts);
        return;
      }
    }
...
void ra_gdhtest::GetNextVolume(void) {
  sGetNextVolume d[] = {{"_V0.254.254.203", "_V254.254.254.245", GDH__SUCCESS},
  ...
  char volumes[][80] = {"_V0.0.0.1",     "_V0.0.0.2",
                        "_V0.0.250.7",   "_V0.254.254.203",
...
void ra_gdhtest::VolumeIdToName(void) {
  sVolumeIdToName d[] = {{"VolPwrTest01c", "_V0.254.254.203", GDH__SUCCESS},
...
void ra_gdhtest::GetVolumeInfo(void) {
  sGetVolumeInfo d[] = {
      ...
      {"1_254_254_203", "_V1.254.254.203", pwr_eClass_SystemVolume,
       GDH__SUCCESS}};
  pwr_tVid vid;
  ...
  for (unsigned int i = 0; i < sizeof(d) / sizeof(d[0]); i++) {
    ...
    if (ODD(m_sts)) {
      if (strcmp(d[i].name, info.name) != 0 || d[i].cid != info.cid) {
...
void ra_gdhtest::DLRefObjectInfoAttrref(void) {
  sDLRefObjectInfoAttrref d[] = {
      {"Test01c-Gdh-Av1.ActualValue", pwr_eType_Float32, sizeof(pwr_tFloat32),
       "222", pwr_cNDlid, GDH__SUCCESS},
      {"Test01c-Gdh-Av1.Description", pwr_eType_String, 80, "Av with value 222",
       pwr_cNDlid, GDH__SUCCESS},
      {"Test01c-Gdh-Dv1.ActualValue", pwr_eType_Boolean, sizeof(pwr_tBoolean),
       "1", pwr_cNDlid, GDH__SUCCESS},
      {"Test01c-Gdh-Dv1.Description", pwr_eType_String, 80,
       "Dv with value true", pwr_cNDlid, GDH__SUCCESS},
      {"Test01c-Gdh-W1.Value", pwr_eType_Float32, 4, "9", pwr_cNDlid,
       GDH__SUCCESS}};
  ...
  for (unsigned int i = 0; i < sizeof(d) / sizeof(d[0]); i++) {
    m_sts = gdh_NameToAttrref(pwr_cNOid, d[i].name, &aref);
    if (EVEN(m_sts)) {
      m_log->log('E', "DLRefObjectInfoAttrref, NameToAttrref", d[i].name,
                 m_sts);
      return;
    }
    ...
    if (m_sts != d[i].sts) {
      ...
      m_sts = gdh_AttrStringToValue(d[i].type, d[i].valuestr, value,
                                    sizeof(value), d[i].size);
      if (EVEN(m_sts)) {
        m_log->log('E', "DLRefObjectInfoAttrref, gdh_AttrStringToValue",
                   d[i].name, m_sts);
        return;
      }
      switch (d[i].type) {
    ...
    if (EVEN(m_sts)) {
      m_log->log('E', "DLRefObjectInfoAttrref, gdh_DLUnrefObjectInfo",
                 d[i].name, m_sts);
      return;
    }
  }
...
void ra_gdhtest::GetTimeDL(void) {
  sGetTimeDL d[] = {{"Test01c-Gdh-ATv1.ActualValue", "21-MAY-2020 8:24:00.00"}};
  ...
  for (unsigned int i = 0; i < sizeof(d) / sizeof(d[0]); i++) {
    ...
    if (EVEN(m_sts)) {
      m_log->log('E', "GetTimeDL, gdh_DLRefObjectInfoAttrref", d[i].name,
                 m_sts);
      return;
    }
...
void ra_gdhtest::SetTimeDL(void) {
  sGetTimeDL d[] = {{"Test01c-Gdh-ATv2.ActualValue", "21-MAY-2020 8:24:00.00"},
  ...
  for (unsigned int i = 0; i < sizeof(d) / sizeof(d[0]); i++) {
    ...
    m_sts = gdh_DLRefObjectInfoAttrref(&aref, (void **)&p, &dlid);
    if (EVEN(m_sts)) {
      m_log->log('E', "SetTimeDL, gdh_DLRefObjectInfoAttrref", d[i].name,
                 m_sts);
      return;
    }
...
void ra_gdhtest::GetDeltaTimeDL(void) {
  sGetTimeDL d[] = {{"Test01c-Gdh-DTv1.ActualValue", "12:12:12.12"}};
  ...
  for (unsigned int i = 0; i < sizeof(d) / sizeof(d[0]); i++) {
    ...
    m_sts = gdh_DLRefObjectInfoAttrref(&aref, (void **)&p, &dlid);
    if (EVEN(m_sts)) {
      m_log->log('E', "GetDeltaTimeDL, gdh_DLRefObjectInfoAttrref", d[i].name,
                 m_sts);
      return;
    }
    ...
    m_sts = gdh_DLUnrefObjectInfo(dlid);
    if (EVEN(m_sts)) {
      m_log->log('E', "GetDeltaTimeDL, gdh_DLUnrefObjectInfo", d[i].name,
                 m_sts);
      return;
    }
  }
...
void ra_gdhtest::SetDeltaTimeDL(void) {
  sGetTimeDL d[] = {{"Test01c-Gdh-DTv2.ActualValue", "2 8:24:00.00"},
  ...
  for (unsigned int i = 0; i < sizeof(d) / sizeof(d[0]); i++) {
    ...
    m_sts = gdh_DLRefObjectInfoAttrref(&aref, (void **)&p, &dlid);
    if (EVEN(m_sts)) {
      m_log->log('E', "SetDeltaTimeDL, gdh_DLRefObjectInfoAttrref", d[i].name,
                 m_sts);
      return;
    }
    ...
    m_sts = gdh_DLUnrefObjectInfo(dlid);
    if (EVEN(m_sts)) {
      m_log->log('E', "SetDeltaTimeDL, gdh_DLUnrefObjectInfo", d[i].name,
                 m_sts);
      return;
    }
  }
...
void ra_gdhtest::GetStrDL(void) {
  sGetTimeDL d[] = {{"Test01c-Gdh-Sv1.ActualValue", "This is a test string"}};
...
void ra_gdhtest::SetStrDL(void) {
  sGetTimeDL d[] = {
      ...
      {"Test01c-Gdh-Sv2.ActualValue", "Test "
                                      "string2345678901234567890123456789012345"
...
void ra_gdhtest::GetObjectInfoDeltaTime(void) {
  ...
  for (unsigned int i = 0; i < sizeof(d) / sizeof(d[0]); i++) {
    ...
    m_sts = time_AsciiToD(d[i].valuestr, &value);
    if (EVEN(m_sts)) {
      m_log->log('E', "GetObjectInfoDeltaTime, time_AsciiToA", d[i].name,
                 m_sts);
      return;
    }
    if (memcmp(&value, &pvalue, sizeof(pwr_tDeltaTime)) != 0) {
...
void ra_gdhtest::SetObjectInfoDeltaTime(void) {
  ...
  for (unsigned int i = 0; i < sizeof(d) / sizeof(d[0]); i++) {
    m_sts = time_AsciiToD(d[i].valuestr, &value);
    if (EVEN(m_sts)) {
      m_log->log('E', "SetObjectInfoDeltaTime, time_AsciiToA", d[i].name,
                 m_sts);
      return;
    }
