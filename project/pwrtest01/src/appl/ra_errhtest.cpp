...
void ra_errhtest::Success(void)
{
  sErrht d[] = {
      ...
      {"This is another success message, %08d",
       eErrht_Int,
       {.i = 222},
       "This is another success message, 00000222"},
      {"This is another success message, %x",
       eErrht_Int,
       {.i = 0xabcd123},
       "This is another success message, abcd123"},
      {"This is another success message, %m",
       eErrht_Sts,
       {.sts = PWR__SUCCESS},
       "This is another success message, %PWR-S-SUCCESS, Successful completion"},
      {"This is another success message, %s",
       eErrht_Str,
       {.s = {'S', 't', 'r', 'i', 'n', 'g', ' ', 'a', 'r', 'g', 'u', 'm', 'e', 'n', 't'}},
       "This is another success message, String argument"}};
...
void ra_errhtest::Info(void)
{
  sErrht d[] = {
      ...
      {"This is another info message, %08d",
       eErrht_Int,
       {.i = 222},
       "This is another info message, 00000222"},
      {"This is another info message, %x",
       eErrht_Int,
       {.i = 0xabcd123},
       "This is another info message, abcd123"},
      {"This is another info message, %m",
       eErrht_Sts,
       {.sts = PWR__SUCCESS},
       "This is another info message, %PWR-S-SUCCESS, Successful completion"},
      {"This is another info message, %s",
       eErrht_Str,
       {.s = {'S', 't', 'r', 'i', 'n', 'g', ' ', 'a', 'r', 'g', 'u', 'm', 'e', 'n', 't'}},
       "This is another info message, String argument"}};
...
void ra_errhtest::Warning(void)
{
  sErrht d[] = {
      ...
      {"This is another warning message, %08d",
       eErrht_Int,
       {.i = 222},
       "This is another warning message, 00000222"},
      {"This is another warning message, %x",
       eErrht_Int,
       {.i = 0xabcd123},
       "This is another warning message, abcd123"},
      {"This is another warning message, %m",
       eErrht_Sts,
       {.sts = PWR__SUCCESS},
       "This is another warning message, %PWR-S-SUCCESS, Successful completion"},
      {"This is another warning message, %s",
       eErrht_Str,
       {.s = {'S', 't', 'r', 'i', 'n', 'g', ' ', 'a', 'r', 'g', 'u', 'm', 'e', 'n', 't'}},
       "This is another warning message, String argument"}};
...
void ra_errhtest::Error(void)
{
  sErrht d[] = {
      ...
      {"This is another error message, %08d",
       eErrht_Int,
       {.i = 222},
       "This is another error message, 00000222"},
      {"This is another error message, %x",
       eErrht_Int,
       {.i = 0xabcd123},
       "This is another error message, abcd123"},
      {"This is another error message, %m",
       eErrht_Sts,
       {.sts = PWR__SUCCESS},
       "This is another error message, %PWR-S-SUCCESS, Successful completion"},
      {"This is another error message, %s",
       eErrht_Str,
       {.s = {'S', 't', 'r', 'i', 'n', 'g', ' ', 'a', 'r', 'g', 'u', 'm', 'e', 'n', 't'}},
       "This is another error message, String argument"}};
...
void ra_errhtest::Fatal(void)
{
  sErrht d[] = {
      ...
      {"This is another fatal message, %08d",
       eErrht_Int,
       {.i = 222},
       "This is another fatal message, 00000222"},
      {"This is another fatal message, %x",
       eErrht_Int,
       {.i = 0xabcd123},
       "This is another fatal message, abcd123"},
      {"This is another fatal message, %m",
       eErrht_Sts,
       {.sts = PWR__SUCCESS},
       "This is another fatal message, %PWR-S-SUCCESS, Successful completion"},
      {"This is another fatal message, %s",
       eErrht_Str,
       {.s = {'S', 't', 'r', 'i', 'n', 'g', ' ', 'a', 'r', 'g', 'u', 'm', 'e', 'n', 't'}},
       "This is another fatal message, String argument"}};
...
{
  sCErrLog d[] = {{PWR__SUCCESS, eErrht_No, {.i = 0}, "PWR-SUCCESS, Successful completion"},
                  {PLC__ERRCREOBJ,
                   eErrht_Str,
                   {.s = {'S', 't', 'r', 'i', 'n', 'g', ' ', 'a', 'r', 'g', 'u', 'm', 'e', 'n', 't'}},
                   "PLC-ERRCREOBJ, create object \'String argument\'"}};
...
{
  sCErrLog d[] = {{PWR__ARUN}, {PWR__SRUN}, {PWR__APPLWARNING}, {PWR__APPLINFO}, {0}};
  ...
  for (unsigned int i = 0; i < sizeof(d) / sizeof(d[0]); i++)
  {
    ...
    {
      m_log->vlog('E', "SetStatus, idx %d (%d != %d)", i, m_nodep->ProcStatus[m_anix - 1], d[i].sts);
      return;
    }
  }
...
{
  sErrht d[] = {{"This is a success message", eErrht_No, {.i = 0}, "S This is a success message"},
                {"This is another success message, %d",
                 eErrht_Int,
                 {.i = 222},
                 "S This is another success message, 222"},
                {"This is another success message, %08d",
                 eErrht_Int,
                 {.i = 222},
                 "S This is another success message, 00000222"},
                {"This is another success message, %x",
                 eErrht_Int,
                 {.i = 0xabcd123},
                 "S This is another success message, abcd123"},
                {"This is another success message, %m",
                 eErrht_Sts,
                 {.sts = PWR__SUCCESS},
                 "S This is another success message, %PWR-S-SUCCESS, Successful completion"},
                {"This is another success message, %s",
                 eErrht_Str,
                 {.s = {'S', 't', 'r', 'i', 'n', 'g', ' ', 'a', 'r', 'g', 'u', 'm', 'e', 'n', 't'}},
                 "S This is another success message, String argument"}};
...
void ra_errhtest::LogInfo(void)
{
  sErrht d[] = {
      ...
      {"This is another info message, %08d",
       eErrht_Int,
       {.i = 222},
       "I This is another info message, 00000222"},
      {"This is another info message, %x",
       eErrht_Int,
       {.i = 0xabcd123},
       "I This is another info message, abcd123"},
      {"This is another info message, %m",
       eErrht_Sts,
       {.sts = PWR__SUCCESS},
       "I This is another info message, %PWR-S-SUCCESS, Successful completion"},
      {"This is another info message, %s",
       eErrht_Str,
       {.s = {'S', 't', 'r', 'i', 'n', 'g', ' ', 'a', 'r', 'g', 'u', 'm', 'e', 'n', 't'}},
       "I This is another info message, String argument"}};
  pwr_tFileName fname, fname2;
  FILE* fp;
  char line[200];
...
void ra_errhtest::LogError(void)
{
  sErrht d[] = {
      ...
      {"This is another error message, %08d",
       eErrht_Int,
       {.i = 222},
       "E This is another error message, 00000222"},
      {"This is another error message, %x",
       eErrht_Int,
       {.i = 0xabcd123},
       "E This is another error message, abcd123"},
      {"This is another error message, %m",
       eErrht_Sts,
       {.sts = PWR__SUCCESS},
       "E This is another error message, %PWR-S-SUCCESS, Successful completion"},
      {"This is another error message, %s",
       eErrht_Str,
       {.s = {'S', 't', 'r', 'i', 'n', 'g', ' ', 'a', 'r', 'g', 'u', 'm', 'e', 'n', 't'}},
       "E This is another error message, String argument"}};
  pwr_tFileName fname, fname2;
  FILE* fp;
  char line[200];
...
void ra_errhtest::LogFatal(void)
{
  sErrht d[] = {
      ...
      {"This is another fatal message, %08d",
       eErrht_Int,
       {.i = 222},
       "F This is another fatal message, 00000222"},
      {"This is another fatal message, %x",
       eErrht_Int,
       {.i = 0xabcd123},
       "F This is another fatal message, abcd123"},
      {"This is another fatal message, %m",
       eErrht_Sts,
       {.sts = PWR__SUCCESS},
       "F This is another fatal message, %PWR-S-SUCCESS, Successful completion"},
      {"This is another fatal message, %s",
       eErrht_Str,
       {.s = {'S', 't', 'r', 'i', 'n', 'g', ' ', 'a', 'r', 'g', 'u', 'm', 'e', 'n', 't'}},
       "F This is another fatal message, String argument"}};
  pwr_tFileName fname, fname2;
  FILE* fp;
  char line[200];
...
// Destructor
ra_errhtest::~ra_errhtest() { delete m_log; }
