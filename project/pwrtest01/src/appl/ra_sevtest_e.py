...
class Ctx:
    ...
    def getSevItemData(self):
        try:
            ...
            result = pwrrt.getSevItemData( 'localhost', '_O0.254.254.205:68', 'ActualValue',
                                            '00:02:00', 'now', 1000)
...
#                return
    ...
    def getSevItemsDataFrame(self):
        ...
        # Append Test01e-H1-Av1.ActualValue
        oidlist.append('_O0.254.254.205:68')
        attrlist.append('ActualValue')
        isobjectlist.append(0)
        # Append Test01e-H1-Av2.ActualValue
        oidlist.append('_O0.254.254.205:69')
        attrlist.append('ActualValue')
        isobjectlist.append(0)
