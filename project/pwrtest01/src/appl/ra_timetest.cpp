...
{
  sAcomp d[] = {{pwr_cNTime, pwr_cNTime, 0},
...
{
  sAdiff d[] = {{pwr_cNTime, pwr_cNTime, 0},
...
{
  sAsub d[] = {{pwr_cNTime, pwr_cNDeltaTime, pwr_cNTime},
...
{
  sDabs d[] = {{pwr_cNDeltaTime, pwr_cNDeltaTime},
               {{0, 1}, {0, 1}},
               {{100, 1}, {100, 1}},
               {{0, -1}, {0, 1}},
               {{-100, -1}, {100, 1}},
...
{
  sDadd d[] = {{pwr_cNDeltaTime, pwr_cNDeltaTime, pwr_cNDeltaTime},
               {{0, 1}, {0, 1}, {0, 2}},
               {{100, 1}, {100, 1}, {200, 2}},
               {{0, -1}, {0, 10}, {0, 9}},
               {{-100, -10}, {100, 1}, {0, -9}},
...
{
  sDadd d[] = {{pwr_cNDeltaTime, pwr_cNDeltaTime, {0, 0}},
               {{0, 1}, {0, 1}, {0, 2}},
               {{102, 1}, {100, 0}, {202, 1}},
               {{-2, -1}, {0, 2}, {-1, -999999999}},
               {{-100, -1}, {100, 1}, {0, 0}},
...
{
  sDneg d[] = {{pwr_cNDeltaTime, pwr_cNDeltaTime},
               {{0, 1}, {0, -1}},
               {{100, 1}, {-100, -1}},
               {{0, -1}, {0, 1}},
               {{-100, -1}, {100, 1}},
...
{
  sDsub d[] = {{pwr_cNDeltaTime, pwr_cNDeltaTime, pwr_cNDeltaTime},
               {{0, 3}, {0, 1}, {0, 2}},
               {{300, 3}, {100, 1}, {200, 2}},
               {{0, -1}, {0, 10}, {0, -11}},
               {{-100, -10}, {100, 1}, {-200, -11}},
...
{
  sDcomp d[] = {{pwr_cNDeltaTime, pwr_cNDeltaTime, 0},
...
{
  sDtoAscii d[] = {{pwr_cNDeltaTime, "0:00:00.00", TIME__SUCCESS},
...
{
  sAsciiToD d[] = {{"0:00:00.00", pwr_cNDeltaTime, TIME__SUCCESS},
...
{
  sAsciiToA d[] = {{"01-JAN-1970 01:00:00.00", pwr_cNTime, TIME__SUCCESS},
  ...
  for (unsigned int i = 0; i < sizeof(d) / sizeof(d[0]); i++)
  {
    ...
    if (ODD(m_sts))
    {
      ...
      {
        m_log->vlog('E', "AsciiToA %s, (%d,%d) != (%d,%d), %d", d[i].str, d[i].time.tv_sec, d[i].time.tv_nsec,
...
{
  sFloat64ToD d[] = {{0, pwr_cNDeltaTime},
                     {1.000, {1, 0}},
                     {456.789, {456, 789000000}},
                     {-123456.789, {-123456, -789000000}},
                     {0.001, {0, 1000000}}};
...
{
  sDToFloat64 d[] = {{pwr_cNDeltaTime, 0},
                     {{1, 0}, 1.000},
                     {{456, 789000000}, 456.789},
                     {{-123456, -789000000}, -123456.789},
                     {{0, 1000000}, 0.001}};
...
// Destructor
ra_timetest::~ra_timetest() { delete m_log; }
