...
public:
  ...
  static void CreateBrowPrintDialogGtk(const char* title, void* brow_ctx, int orientation, double scale,
                                       void* parent_widget, pwr_tStatus* sts);
  ...
  static void CreateFlowPrintDialogGtk(const char* title, void* flow_ctx, int orientation, double scale,
                                       void* parent_widget, pwr_tStatus* sts);
