...
dcli_tCmdTable nodelist_command_table[] = {
    ...
    {"OPEN",
     &nodelist_open_func,
     {"dcli_arg1", "dcli_arg2", "/WIDTH", "/HEIGHT", "/TITLE", "/NODE", "/FILE", ""}},
    {"HELP",
     &nodelist_help_func,
...
int Nodelist::command(char* input_str)
{
  ...
  sts = dcli_cli((dcli_tCmdTable*)&nodelist_command_table, command, (void*)this, 0);
  if (sts == DCLI__COM_NODEF)
  {
    ...
    if (ODD(sym_sts))
    {
      ...
      sts = dcli_cli((dcli_tCmdTable*)&nodelist_command_table, symbol_value, (void*)this, 0);
    }
...
static int nodelist_ccm_deffilename_func(char* outfile, char* infile, void* client_data)
{
...
static int nodelist_ccm_errormessage_func(char* msg, int severity, void* client_data)
{
  Nodelist* nl = (Nodelist*)client_data;
...
int Nodelist::readcmdfile(char* incommand, char* script)
{
  ...
  if (incommand)
  {
    ...
    sts = ccm_file_exec(input_str, nodelist_externcmd_func, nodelist_ccm_deffilename_func,
                        nodelist_ccm_errormessage_func, &appl_sts, verify, 0, NULL, 0, 0, NULL, (void*)this);
  }
  else if (script)
  {
    sts = ccm_buffer_exec(script, 0, nodelist_externcmd_func, nodelist_ccm_deffilename_func,
                          nodelist_ccm_errormessage_func, &appl_sts, verify, 0, NULL, 0, NULL, (void*)this);
  }
  if (EVEN(sts))
    return sts;
  return 1;
