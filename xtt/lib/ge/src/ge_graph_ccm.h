...
#define CCM_DECL_UNKNOWN 4
  ...
  int gccm_file_exec(char* buff, int (*externcmd_func)(char*, void*),
                     ...
                     int (*errormessage_func)(char*, int, void*), int* appl_sts, int verify, int break_before,
                     void** ctx, int extfunc_return_mode, int resume, char* extfunc_line, void* client_data,
                     gccm_s_arglist* pwr_arglist);

  int gccm_create_external_var(char* name, int decl, float value_float, int value_int, char* value_string);

  int gccm_set_external_var(char* name, int decl, float value_float, int value_int, char* value_string);

  int gccm_get_pwr_argnames(char* inbuff, int (*errormessage_func)(char*, int, void*), char* pwr_argnames,
                            int* pwr_argtypes, int* pwr_argcnt);

  int gccm_create_pwr_args(char* pwr_argnames, int* pwr_argtypes, char** pwr_argvalues, int pwr_argcnt,
