...
class GeGtk : public Ge
{
  ...
  GtkToolItem* grid_on_w;
  GtkWidget* gridsize_combo;
  GtkToolItem* show_grid_w;
...
public:
  GeGtk(void* parent_ctx, GtkWidget* parent_widget, ldh_tSesContext ldhses, int exit_when_close,
  ...
  static void activate_linewidth_combo(GtkWidget* w, gpointer gectx);
  static void activate_linetype_combo(GtkWidget* w, gpointer gectx);
  static void activate_gridsize_combo(GtkWidget* w, gpointer gectx);
  static void activate_textsize_combo(GtkWidget* w, gpointer gectx);
  static void activate_font_combo(GtkWidget* w, gpointer gectx);
