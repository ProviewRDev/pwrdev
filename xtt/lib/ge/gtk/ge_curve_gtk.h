...
public:
  ...
  GtkWidget* menu_add;
  GtkToolItem* tools_snapshot;
  GtkToolItem* tools_add;
  GtkToolItem* tools_curvetype_line;
  GtkToolItem* tools_curvetype_points;
  GtkToolItem* tools_curvetype_linepoints;
  GtkToolItem* tools_curvetype_square;
  GtkToolItem* tools_curve_fill;
  GtkToolItem* tools_curve_digsplit;
