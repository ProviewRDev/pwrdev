...
#include "onvif_wsaapi.h"     /* also includes soapH.h, see wsaapi.h if you are using a different fileH.h */
#include "onvif_threads.h"    /* threads and locks from plugin/threads.h */
