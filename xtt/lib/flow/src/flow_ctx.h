...
public:
  ...
  int insert(FlowArrayElem* element) { return a.insert(element); }
  void remove(FlowArrayElem* element) { a.remove(element); }
  void delete_all();
  ...
  int nodeclass_insert(FlowArrayElem* element) { return a_nc.insert(element); }
  int conclass_insert(FlowArrayElem* element) { return a_cc.insert(element); }
  int select_insert(FlowArrayElem* element) { return a_sel.insert(element); }
  void select_remove(FlowArrayElem* element) { a_sel.remove(element); }
  void select_clear();
  int select_find(FlowArrayElem* element) { return a_sel.find(element); }
  int move_insert(FlowArrayElem* element) { return a_move.insert(element); }
  void move_remove(FlowArrayElem* element) { a_move.remove(element); }
  void move_clear() { a_move.clear(); }
  int move_find(FlowArrayElem* element) { return a_move.find(element); }
  int paste_insert(FlowArrayElem* element) { return a_paste.insert(element); }
  void paste_remove(FlowArrayElem* element) { a_paste.remove(element); }
  void paste_clear() { a_paste.clear(); } // Delete objects also !!!
  int paste_find(FlowArrayElem* element) { return a_paste.find(element); }
  void paste();
  void paste_execute();
  void cut();
  void copy();
  void set_highlight(int on) { a.set_highlight(on); }
  void set_dimmed(int on) { a.set_dimmed(on); }
  ...
  int print_region(double ll_x, double ll_y, double ur_x, double ur_y, char* filename);
  int print_pdf_region(double ll_x, double ll_y, double ur_x, double ur_y, char* filename);
  ...
  void conpoint_refcon_redraw(void* node, int conpoint) { a.conpoint_refcon_redraw(node, conpoint); }
  void conpoint_refcon_erase(void* node, int conpoint) { a.conpoint_refcon_erase(node, conpoint); }
  ...
  int trace_init(int (*connect_func)(void*, char*, char*, flow_eTraceType, void**),
  ...
  int find_by_name(char* name, FlowArrayElem** element) { return a.find_by_name(name, element); }
  ...
  int get_next_object(FlowArrayElem* object, flow_eDirection dir, FlowArrayElem** next);
  int get_next_conpoint(FlowArrayElem* object, int cp_num, flow_eDirection dir, FlowArrayElem** next,
                        int* next_cp_num);
