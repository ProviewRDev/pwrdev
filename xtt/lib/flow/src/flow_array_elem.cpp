...
void FlowArrayElem::get_borders(double* x_right, double* x_left, double* y_high, double* y_low) {}

void FlowArrayElem::get_borders(double pos_x, double pos_y, double* x_right, double* x_left, double* y_high,
...
int FlowArrayElem::event_handler(flow_eEvent event, int x, int y) { return 0; }

int FlowArrayElem::event_handler(void* pos, flow_eEvent event, int x, int y, void* node) { return 0; }
...
void FlowArrayElem::draw(void* pos, int highlight, int dimmed, int hot, void* node) {}
...
void FlowArrayElem::shift(void* pos, double delta_x, double delta_y, int highlight, int dimmed, int hot) {}
...
void FlowArrayElem::conpoint_select(void* pos, int x, int y, double* distance, void** cp) {}

int FlowArrayElem::get_conpoint(int num, double* x, double* y, flow_eDirection* dir) { return 0; }

void FlowArrayElem::redraw_node_cons(void* node) {}

int FlowArrayElem::delete_node_cons(void* node) { return 0; }

void FlowArrayElem::set_highlight(int on) {}

int FlowArrayElem::get_highlight() { return 1; }

void FlowArrayElem::set_dimmed(int on) {}

int FlowArrayElem::get_dimmed() { return 1; }

void FlowArrayElem::set_inverse(int on) {}

void FlowArrayElem::set_hot(int on) {}

void FlowArrayElem::select_region_insert(double ll_x, double ll_y, double ur_x, double ur_y) {}

flow_eObjectType FlowArrayElem::type() { return flow_eObjectType_NoObject; }

void FlowArrayElem::link_insert(FlowArrayElem** start) {}

int FlowArrayElem::in_area(double ll_x, double ll_y, double ur_x, double ur_y) { return 0; }

int FlowArrayElem::in_area_exact(double ll_x, double ll_y, double ur_x, double ur_y) { return 0; }

int FlowArrayElem::in_vert_line(double x, double l_y, double u_y) { return 0; }

int FlowArrayElem::in_horiz_line(double y, double l_x, double u_x) { return 0; }
...
int FlowArrayElem::trace_init() { return 1; }

void FlowArrayElem::trace_close() {}

void FlowArrayElem::set_trace_attr(const char* object, const char* attribute, flow_eTraceType type,
                                   int inverted)
{
}

FlowTraceAttr FlowArrayElem::get_trace_attr() { return FlowTraceAttr(); }

void* FlowArrayElem::get_ctx() { return NULL; }
