...
{
public:
  FlowConClass(FlowCtx* flow_ctx, const char* name, flow_eConType contype, flow_eCorner cornertype,
               flow_eDrawType d_type, int line_w, double arrow_w = 0, double arrow_l = 0,
               double round_corner_amnt = 0.5, flow_eConGroup grp = flow_eConGroup_Common);
  ...
  int event_handler(void* pos, flow_eEvent event, int x, int y, void* node) { return 0; }
