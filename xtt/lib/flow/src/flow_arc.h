...
public:
  FlowArc() {}
  FlowArc(FlowCtx* flow_ctx, double x1 = 0, double y1 = 0, double x2 = 0, double y2 = 0, int ang1 = 0,
          int ang2 = 0, flow_eDrawType d_type = flow_eDrawType_Line, int line_w = 1)
      : ctx(flow_ctx), angle1(ang1), angle2(ang2), ll(flow_ctx, x1, y1), ur(flow_ctx, x2, y2),
