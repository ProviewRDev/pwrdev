...
extern "C"
{
  ...
  void brow_CreateNode(brow_tCtx ctx, const char* name, brow_tNodeClass nc, brow_tNode destination,
                       flow_eDest destination_code, void* user_data, int relative_annot_pos,
                       brow_tNode* node);
  void brow_CreatePasteNode(brow_tCtx ctx, char* name, brow_tNodeClass nc, double x, double y,
                            void* user_data, brow_tNode* node);
  ...
  void brow_EnableEvent(BrowCtx* ctx, flow_eEvent event, flow_eEventType event_type,
  ...
  void brow_CreateRect(brow_tCtx ctx, double x, double y, double width, double height,
                       flow_eDrawType draw_type, int line_width, int fix_line_width, brow_tObject* rect);
  ...
  void brow_CreateAnnotPixmap(brow_tCtx ctx, int number, double x, double y, flow_eDrawType draw_type,
                              int size, int relative_pos, brow_tObject* annot_pixmap);
  void brow_CreateAnnot(brow_tCtx ctx, double x, double y, int number, flow_eDrawType draw_type,
                        int text_size, brow_tObject* annot);
  ...
  void brow_AddRadiobutton(brow_tNodeClass nc, double x, double y, double width, double height, int number,
                           flow_eDrawType draw_type, int line_width);
  void brow_CreatePushButton(brow_tCtx ctx, char* text, double x, double y, double width, double height,
                             brow_tObject* pushbutton);
  ...
  int brow_TraceInit(brow_tCtx ctx,
                     int (*trace_connect_func)(brow_tObject, char*, char*, flow_eTraceType, void**),
                     int (*trace_disconnect_func)(brow_tObject), int (*trace_scan_func)(brow_tObject, void*));
  ...
  void brow_MeasureAnnotation(brow_tNodeClass node_class, int number, char* text, double* width,
                              double* height);
