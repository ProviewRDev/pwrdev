...
XttOTreeQt::XttOTreeQt(void* xn_parent_ctx, const char* title, pwr_tAttrRef* xn_itemlist, int xn_item_cnt,
...
{
  cowtree = new CowTreeQt(this, title, xn_itemlist, xn_item_cnt, xn_options, &get_object_info, &get_node_info,
                          &action);
  cowtree->close_cb = close;
}

XttOTreeQt::~XttOTreeQt() { delete cowtree; }
