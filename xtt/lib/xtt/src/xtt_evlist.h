...
typedef struct {
  ...
  char b_alarm_text[ALARM_INFO_B_SIZE][200];
  ...
  char c_alarm_text[ALARM_INFO_C_SIZE][200];
  ...
  char d_alarm_text[ALARM_INFO_D_SIZE][200];
  ...
  char i_alarm_text[ALARM_INFO_I_SIZE][200];
