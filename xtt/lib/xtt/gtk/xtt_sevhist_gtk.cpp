...
XttSevHistGtk::XttSevHistGtk(void* parent_ctx, GtkWidget* parent_wid, const char* name, GtkWidget** w,
...
XttSevHistGtk::XttSevHistGtk(void* parent_ctx, GtkWidget* parent_wid, const char* name, GtkWidget** w,
    ...
    : XttSevHist(parent_ctx, name, filename, xn_color_theme, sts), parent_widget(parent_wid)
{
  char title[250];
  strncpy(title, name, sizeof(title));
