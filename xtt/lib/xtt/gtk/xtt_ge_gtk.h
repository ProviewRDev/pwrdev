...
public:
  ...
  XttGeGtk(GtkWidget* parent_wid, void* parent_ctx, const char* name, const char* filename, int scrollbar,
  ...
  void get_context_menu(void* mdata, xmenu_mUtility caller, unsigned int priv, char* arg, int x, int y);
