...
public:
  ...
  virtual void get_borders(GlowTransform* t, double* x_right, double* x_left, double* y_high, double* y_low)
  {
  }
  ...
  virtual int event_handler(GlowWind* w, glow_eEvent event, int x, int y) { return 0; }
  virtual int event_handler(GlowWind* w, glow_eEvent event, int x, int y, double fx, double fy) { return 0; }
  ...
  virtual void shift(void* pos, double delta_x, double delta_y, int highlight, int hot) {}
  ...
  virtual void conpoint_select(GlowTransform* t, int x, int y, double* distance, void** cp, int* pix_x,
                               int* pix_y)
  {
  }
  virtual int get_conpoint(int num, double* x, double* y, glow_eDirection* dir) { return 0; }
  virtual int get_conpoint(GlowTransform* t, int num, bool flip_horizontal, bool flip_vertical, double* x,
  ...
  virtual int in_area(double ll_x, double ll_y, double ur_x, double ur_y) { return 0; }
  virtual int in_area_exact(double ll_x, double ll_y, double ur_x, double ur_y) { return 0; }
  ...
  virtual void set_scale(double scale_x, double scale_y, double x0, double y0, glow_eScaleType type) {}
  virtual void set_scale_pos(double scale_x, double x, double y, double scale_y, double x0, double y0,
                             glow_eScaleType type)
  {
  }
  virtual void set_rotation(double angle, double x0, double y0, glow_eRotationPoint type) {}
  ...
  virtual int get_background_object_limits(GlowTransform* t, glow_eTraceType type, double x, double y,
  ...
  virtual int export_script(GlowExportScript* es, void* o, void* m) { return 0; }
  ...
  virtual double get_transparency() { return 0; }
