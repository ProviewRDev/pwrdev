...
public:
  ...
  */
  ...
  void copy_from_common_objects(GlowArray& array) { a.copy_from_common_objects(array); }
  ...
  int find_by_name(const char* name, GlowArrayElem** element) { return a.find_by_name(name, element); }
  void clear() { a.clear(); }
  ...
  int event_handler(GlowWind* w, glow_eEvent event, int x, int y) { return a.event_handler(w, event, x, y); }
  ...
  void move(double delta_x, double delta_y, int grid) { a.move(delta_x, delta_y, grid); }
  void move_noerase(int delta_x, int delta_y, int grid) { a.move_noerase(delta_x, delta_y, grid); }
  ...
  int get_previous(GlowArrayElem* element, GlowArrayElem** prev) { return a.get_previous(element, prev); }
  int get_next(GlowArrayElem* element, GlowArrayElem** next) { return a.get_next(element, next); }
