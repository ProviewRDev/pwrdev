...
extern "C"
{
  ...
  */
  ...
  /*!
    ...
    \param node		Created GrowNode object.
  */
  void grow_CreatePasteNode(grow_tCtx ctx, char* name, grow_tNodeClass nc, double x, double y,
                            void* user_data, grow_tNode* node);
  ...
  */
  void grow_EnableEvent(GrowCtx* ctx, glow_eEvent event, glow_eEventType event_type,
  ...
  */
  ...
  void grow_CreateRect(grow_tCtx ctx, double x, double y, double width, double height,
                       glow_eDrawType draw_type, int line_width, int fix_line_width, grow_tObject* rect);
  ...
  void grow_AddPolyLine(grow_tNodeClass, const char* name, glow_sPoint* pointarray, int point_cnt,
  ...
  void grow_AddArc(grow_tNodeClass nc, const char* name, double x1, double y1, double x2, double y2,
                   int angle1, int angle2, glow_eDrawType draw_type, int line_width, int fill_arc, int border,
                   int shadow, glow_eDrawType fill_draw_type, void* user_data);
  ...
  */
  int grow_TraceInit(grow_tCtx ctx, int (*trace_connect_func)(grow_tObject, GlowTraceData*),
                     int (*trace_disconnect_func)(grow_tObject), int (*trace_scan_func)(grow_tObject, void*),
  ...
  */
  void grow_CreateGrowBarArc(grow_tCtx ctx, const char* name, double x1, double y1, double x2, double y2,
                             int ang1, int ang2, double width, glow_eDrawType border_draw_type,
                             int line_width, int border, glow_eDrawType fill_draw_type, void* user_data,
                             grow_tObject* bar);
  ...
  */
  void grow_CreateGrowXYCurve(grow_tCtx ctx, const char* name, double x, double y, double width,
  ...
  */
  void grow_CreateGrowFolder(grow_tCtx ctx, const char* name, double x, double y, double width, double height,
                             ...
                             glow_eDrawType unselected_color, glow_mDisplayLevel display_level,
                             void* user_data, grow_tObject* window);

  void grow_CreateGrowToolbar(grow_tCtx ctx, const char* name, const char* nc_name, char* tools1,
                              char* tools2, int tools1_cnt, int tools2_cnt, double x, double y,
                              void* user_data, grow_tObject* toolbar);
  ...
  */
  ...
  void grow_CreateGrowBarChart(grow_tCtx ctx, const char* name, double x, double y, double width,
                               double height, glow_eDrawType draw_type, int line_width, int border,
                               int shadow, glow_eDrawType fill_draw_type, void* user_data,
                               grow_tObject* barchart);
  ...
  */
  ...
  //! Create a dash cell
  void grow_CreateGrowDashCell(grow_tCtx ctx, const char* name, double x, double y, double width,
                               double height, glow_eDrawType draw_type, void* user_data, grow_tObject* cell);
  ...
  */
  void grow_SetObjectRotation(grow_tObject object, double angle, double x0, double y0,
  ...
  */
  ...
  /*!
    ...
    \param arg_cnt	Pointer to number of arguments.
  */
  void grow_GetObjectArgs(grow_tObject object, char** argnames, int** argtypes, char*** argvalues,
                          int* arg_cnt);
  ...
  */
  ...
  int grow_OrderGroupObject(grow_tObject group, grow_tObject object, grow_tObject destination,
                            glow_eDest code);
  ...
  */
  ...
  /*!
    ...
    direction.
  */
  void grow_GetSliderInfo(grow_tObject object, glow_eDirection* direction, double* max_value,
                          double* min_value, double* max_pos, double* min_pos);
  ...
  */
  void grow_GetMenuChar(grow_tObject menu, int* t_size, glow_eDrawType* fill_color,
                        glow_eDrawType* t_drawtype, glow_eDrawType* t_color, glow_eDrawType* t_color_disabled,
                        glow_eFont* t_font);
