...
public:
  ...
  virtual int image_d(GlowWind* wind, double x, double y, int width, int height, glow_tImImage img,
                      glow_tPixmap pixmap, glow_tPixmap clip_mask);
  ...
  virtual int image_load(char* imagefile, glow_tImImage* orig_im, glow_tImImage* im, glow_tImData* im_data);
  virtual int image_render(int width, int height, glow_tImImage orig_im, glow_tImImage* im,
