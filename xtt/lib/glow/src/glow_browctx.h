...
public:
  BrowCtx(const char* ctx_name, double zoom_fact = 100)
      : GlowCtx(ctx_name, zoom_fact), indentation(0.8), frame_x_right(0), annotation_space(0.3)
  {
    ctx_type = glow_eCtxType_Brow;
  }
  ~BrowCtx() {}
  int insert(GlowArrayElem* element, GlowArrayElem* destination, glow_eDest destination_code);
