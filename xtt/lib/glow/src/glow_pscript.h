...
public:
  ...
  int arc(double x, double y, double width, double height, int angle1, int angle2, glow_eDrawType type,
          int idx);
  ...
  int arrow(double x1, double y1, double x2, double y2, double x3, double y3, glow_eDrawType type, int idx);
