...
public:
  ...
  */
  GrowAxisArc(GrowCtx* glow_ctx, const char* name, double x1 = 0, double y1 = 0, double x2 = 0, double y2 = 0,
              int ang1 = 0, int ang2 = 0, glow_eDrawType border_d_type = glow_eDrawType_Line, int line_w = 1,
              int t_size = 2, glow_eDrawType t_drawtype = glow_eDrawType_TextHelvetica, int nodraw = 0);
