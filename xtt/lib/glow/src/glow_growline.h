...
public:
  ...
  */
  GrowLine(GrowCtx* glow_ctx, const char* name, double x1 = 0, double y1 = 0, double x2 = 0, double y2 = 0,
           glow_eDrawType d_type = glow_eDrawType_Line, int line_w = 1, int fix_line_w = 0, int nodraw = 0);
