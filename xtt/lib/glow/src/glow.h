...
typedef enum {
  ...
  glow_eSave_GrowRect_transparency = 1927,
  ...
  glow_eSave_GrowLine_transparency = 2011,
  ...
  glow_eSave_GrowArc_transparency = 2427,
  glow_eSave_GrowArc_border_eq_light = 2428,
  glow_eSave_GrowArc_border_eq_shadow = 2429,
  ...
  glow_eSave_GrowPolyLine_transparency = 2630,
  glow_eSave_GrowPolyLine_border_eq_light = 2631,
  glow_eSave_GrowPolyLine_border_eq_shadow = 2632,
  ...
  glow_eSave_GrowNode_transparency = 2733,
  ...
  glow_eSave_GrowText_transparency = 3012,
  ...
  glow_eSave_GrowRectRounded_fixcolor = 3825,
