...
GrowBar::GrowBar(GrowCtx* glow_ctx, const char* name, double x, double y, double w, double h,
    ...
    : GrowRect(glow_ctx, name, x, y, w, h, border_d_type, line_w, 0, display_lev, fill_rect, display_border,
      ...
      max_value(100), min_value(0), bar_value(35), bar_drawtype(glow_eDrawType_Inherit),
...
void GrowBar::save(std::ostream& fp, glow_eSaveMode mode)
{
  ...
  fp << int(glow_eSave_GrowBar_bar_bordercolor) << FSPACE << int(bar_bordercolor) << '\n';
                   ...
                   void* transpnode)
{
  ...
  int bar_border_idx = int(w->zoom_factor_y / w->base_zoom_factor * bar_borderwidth - 1);
...
void GrowBar::set_trace_attr(GlowTraceData* attr) { memcpy(&trace, attr, sizeof(trace)); }

void GrowBar::get_trace_attr(GlowTraceData** attr) { *attr = &trace; }
                              ...
                              int node_cnt, int in_nc, std::ostream& fp)
{
  ...
  ctx->export_jbean->bar(ll_x, ll_y, ur_x, ur_y, draw_type, fill_drawtype, bar_drawtype, bar_bordercolor,
                         fill, border, min_value, max_value, bar_borderwidth, line_width, rotation, pass,
...
int GrowBar::export_script(GlowExportScript* es, void* o, void* m) { return es->bar(this, o, m); }
