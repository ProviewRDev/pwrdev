...
void Misc_PingPongFo_exec(plc_sThread* tp, pwr_sClass_Misc_PingPongFo* o)
{
  ...
  case pwr_eMisc_PingPongModeEnum_Idle:
  {
    ...
    {
      co->XCoordinate = co->Width - co->BallRadius - (co->XCoordinate + co->BallRadius - co->Width);
      if (co->Direction > 0)
        co->Direction = -co->Direction + 180 + my_random() * 10;
      else
        co->Direction = -co->Direction - 180 + my_random() * 10;
    ...
    {
      co->YCoordinate = co->Height - co->BallRadius - (co->YCoordinate + co->BallRadius - co->Height);
      co->Direction = -co->Direction;
    }
    break;
  }
