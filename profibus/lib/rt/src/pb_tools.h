...
/*----- function prototypes to get default busparameters -------------------*/
#ifdef __PB_DP__
  FUNCTION extern PB_BOOL CALL_CONV pbt_get_dp_def_bus_param(IN USIGN8 BaudRate, IN USIGN8 StationAddr,
                                                             IN USIGN16 Mode,
...
#ifdef __PB_FM7__
  FUNCTION extern PB_BOOL CALL_CONV
  pbt_get_fms_fm7_def_bus_param(IN USIGN8 BaudRate, IN USIGN8 StationAddr, IN PB_BOOL InRingDesired,
...
#ifdef __PB_FDL__
  FUNCTION extern PB_BOOL CALL_CONV
  pbt_get_fdlif_def_bus_param(IN USIGN8 BaudRate, IN USIGN8 StationAddr, IN PB_BOOL InRingDesired,
...
#ifdef __PB_FMB__
  FUNCTION extern PB_BOOL CALL_CONV
  pbt_get_fmb_def_bus_param(IN USIGN8 BaudRate, IN USIGN8 StationAddr, IN PB_BOOL InRingDesired,
  ...
  FUNCTION extern USIGN16 CALL_CONV ccrl_resrces_add_entry(IN USIGN16 Cr, IN T_CRL_STATIC FAR* pCrlStatic,
