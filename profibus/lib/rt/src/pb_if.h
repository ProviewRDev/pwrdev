...
extern "C"
{
  ...
  FUNCTION extern INT16 CALL_CONV profi_set_default(IN USIGN8 Board, IN USIGN8 Channel,
  ...
  FUNCTION extern INT16 CALL_CONV profi_init(IN USIGN8 Board, IN USIGN32 ReadTimeout, IN USIGN32 WriteTimeout)
      /*----------------------------------------------------------------------------
      FUNCTIONAL_DESCRIPTION
  ...
  FUNCTION extern INT16 CALL_CONV init_profibus(IN USIGN32 DprAdress, IN USIGN16 IoPortAdress,
                                                IN PB_BOOL Dummy)
  ...
  FUNCTION extern INT16 CALL_CONV profi_snd_req_res(IN T_PROFI_SERVICE_DESCR* pSdb, IN VOID* pData,
                                                    IN PB_BOOL dummy)
  ...
  FUNCTION extern INT16 CALL_CONV profi_rcv_con_ind(OUT T_PROFI_SERVICE_DESCR* pSdb, OUT VOID* pData,
  ...
  FUNCTION extern INT16 CALL_CONV profi_set_data(IN USIGN8 DataId, IN USIGN16 Offset, IN USIGN16 DataLength,
                                                 IN VOID* pData)
  ...
  FUNCTION extern INT16 CALL_CONV profi_get_data(IN USIGN8 DataId, IN USIGN16 Offset,
  ...
  FUNCTION extern INT16 CALL_CONV profi_set_dps_input_data(IN USIGN8* pData, IN USIGN8 DataLength,
                                                           OUT USIGN8* pState)
  ...
  FUNCTION extern INT16 CALL_CONV profi_get_dps_input_data(OUT USIGN8* pData, INOUT USIGN8* pDataLength,
                                                           OUT USIGN8* pState)
  ...
  FUNCTION extern INT16 CALL_CONV profi_get_dps_output_data(OUT USIGN8* pData, INOUT USIGN8* pDataLength,
                                                            OUT USIGN8* pState)
  ...
  FUNCTION extern INT16 CALL_CONV profi_get_versions(OUT CSTRING* pPapiVersion, OUT CSTRING* pFirmwareVersion)
      /*----------------------------------------------------------------------------
      FUNCTIONAL_DESCRIPTION
  ...
  FUNCTION extern INT16 CALL_CONV profi_get_serial_device_number(OUT USIGN32* pSerialDeviceNumber)
      /*----------------------------------------------------------------------------
      FUNCTIONAL_DESCRIPTION
  ...
  FUNCTION extern HANDLE CALL_CONV profi_open_basic_management(IN USIGN8 Board, IN USIGN8 Channel,
  ...
  FUNCTION extern HANDLE CALL_CONV profi_open(IN HANDLE hBasicMgmtDevice, IN INT32 DeviceType,
                                              IN USIGN32 Index, IN INT32 DesiredAccess)
      /*----------------------------------------------------------------------------
      FUNCTIONAL_DESCRIPTION
  ...
  FUNCTION extern INT16 CALL_CONV profi_read_service(IN HANDLE hDevice, OUT T_PROFI_SERVICE_DESCR* pSdb,
  ...
  FUNCTION extern INT16 CALL_CONV profi_write_service(IN HANDLE hDevice, IN T_PROFI_SERVICE_DESCR* pSdb,
                                                      IN VOID* pData)
      /*----------------------------------------------------------------------------
      FUNCTIONAL_DESCRIPTION
  ...
  FUNCTION extern INT16 CALL_CONV profi_read_multi(OUT T_PROFI_SERVICE_DESCR* pSdb, OUT VOID* pData,
  ...
  FUNCTION extern INT16 CALL_CONV profi_read_data(IN HANDLE hDevice, OUT VOID* pData,
  ...
  FUNCTION extern INT16 CALL_CONV profi_write_data(IN HANDLE hDevice, IN VOID* pData, IN USIGN16 DataLength)
      /*----------------------------------------------------------------------------
      FUNCTIONAL_DESCRIPTION
  ...
  FUNCTION extern INT16 CALL_CONV profi_read_dps_data(IN HANDLE hDevice, OUT USIGN8* pData,
  ...
  FUNCTION extern INT16 CALL_CONV profi_write_dps_data(IN HANDLE hDevice, IN USIGN8* pData,
  ...
  FUNCTION extern BOOL CALL_CONV profi_get_cntrl_info(IN USIGN8 Board, OUT char* pFirmwareVersion,
  ...
  FUNCTION extern BOOL CALL_CONV profi_set_timeout(IN HANDLE hBasicMgmtDevice, IN USIGN32 ReadTimeout,
  ...
  FUNCTION extern BOOL CALL_CONV profi_get_timeout(IN HANDLE hBasicMgmtDevice, OUT USIGN32* pReadTimeout,
  ...
  FUNCTION extern BOOL CALL_CONV profi_set_queue_size(IN HANDLE hBasicMgmtDevice, IN USIGN32 QueueSize)
      /*----------------------------------------------------------------------------
      FUNCTIONAL_DESCRIPTION
  ...
  FUNCTION extern BOOL CALL_CONV profi_get_queue_size(IN HANDLE hBasicMgmtDevice, OUT USIGN32* pQueueSize)
      /*----------------------------------------------------------------------------
      FUNCTIONAL_DESCRIPTION
  ...
  FUNCTION extern BOOL CALL_CONV profi_get_overrun_count(IN HANDLE hBasicMgmtDevice,
