...
// public:
//   PnSubmoduleData()
//       : subslot_number(0), subslot_idx(0), type(0), state(0), ident_number(0), phys_ident_number(0), api(0)
//   {
//   }
...
// {
// public:
//   PnDeviceData() : device_ref(0), alarm_ref(0), device_state(0), no_diff_modules(0)
//   {
...
public:
  ...
  // TODO Remove these in favor for the conf in ProfinetDevice?
  // unsigned char ipaddress[4];
  // unsigned char macaddress[6];
  // unsigned char subnetmask[4];
