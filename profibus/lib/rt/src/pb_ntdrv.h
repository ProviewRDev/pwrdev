...
#define IOCTL_PROFI_CREATE_DP_MANAGEMENT                                                                     \
  (ULONG) CTL_CODE(FILE_DEVICE_PROFIBOARD, 0x800, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define IOCTL_PROFI_CREATE_DP_SERVICE                                                                        \
  (ULONG) CTL_CODE(FILE_DEVICE_PROFIBOARD, 0x801, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define IOCTL_PROFI_CREATE_DP_SLAVE_DATA                                                                     \
  (ULONG) CTL_CODE(FILE_DEVICE_PROFIBOARD, 0x802, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define IOCTL_PROFI_CREATE_FDL_MANAGEMENT                                                                    \
  (ULONG) CTL_CODE(FILE_DEVICE_PROFIBOARD, 0x803, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define IOCTL_PROFI_CREATE_FDL_SAP                                                                           \
  (ULONG) CTL_CODE(FILE_DEVICE_PROFIBOARD, 0x804, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define IOCTL_PROFI_CREATE_FMS_MANAGEMENT                                                                    \
  (ULONG) CTL_CODE(FILE_DEVICE_PROFIBOARD, 0x805, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define IOCTL_PROFI_CREATE_FMS_CR                                                                            \
  (ULONG) CTL_CODE(FILE_DEVICE_PROFIBOARD, 0x806, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define IOCTL_PROFI_CREATE_DP_MSAC                                                                           \
  (ULONG) CTL_CODE(FILE_DEVICE_PROFIBOARD, 0x80e, METHOD_BUFFERED, FILE_ANY_ACCESS)

#define IOCTL_PROFI_SET_TIMEOUT                                                                              \
  (ULONG) CTL_CODE(FILE_DEVICE_PROFIBOARD, 0x808, METHOD_BUFFERED, FILE_READ_ACCESS)
#define IOCTL_PROFI_GET_TIMEOUT                                                                              \
  (ULONG) CTL_CODE(FILE_DEVICE_PROFIBOARD, 0x809, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define IOCTL_PROFI_SET_QUEUE_SIZE                                                                           \
  (ULONG) CTL_CODE(FILE_DEVICE_PROFIBOARD, 0x80a, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define IOCTL_PROFI_GET_QUEUE_SIZE                                                                           \
  (ULONG) CTL_CODE(FILE_DEVICE_PROFIBOARD, 0x80b, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define IOCTL_PROFI_GET_OVERRUN_COUNT                                                                        \
  (ULONG) CTL_CODE(FILE_DEVICE_PROFIBOARD, 0x80c, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define IOCTL_PROFI_READ_MULTI                                                                               \
  (ULONG) CTL_CODE(FILE_DEVICE_PROFIBOARD, 0x80d, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define IOCTL_PROFI_GET_DATA_IMAGE                                                                           \
  (ULONG) CTL_CODE(FILE_DEVICE_PROFIBOARD, 0x80f, METHOD_BUFFERED, FILE_ANY_ACCESS)

#define IOCTL_PROFI_SET_DPS_DATA                                                                             \
  (ULONG) CTL_CODE(FILE_DEVICE_PROFIBOARD, 0x810, METHOD_IN_DIRECT, FILE_ANY_ACCESS)

#define IOCTL_PROFI_SET_DP_BITS                                                                              \
  (ULONG) CTL_CODE(FILE_DEVICE_PROFIBOARD, 0x811, METHOD_BUFFERED, FILE_WRITE_ACCESS)
#define IOCTL_PROFI_CLEAR_DP_BITS                                                                            \
  (ULONG) CTL_CODE(FILE_DEVICE_PROFIBOARD, 0x812, METHOD_BUFFERED, FILE_WRITE_ACCESS)

#define IOCTL_PROFI_CHECK_DEV_CONN                                                                           \
  (ULONG) CTL_CODE(FILE_DEVICE_PROFIBOARD, 0x813, METHOD_BUFFERED, FILE_ANY_ACCESS)
