...
T_PNAK_RESULT pnak_wait_for_multiple_objects(unsigned short a1, T_PNAK_WAIT_OBJECT* a2, T_PNAK_TIMEOUT a3)
{
  return PNAK_OK;
}
...
T_PNAK_RESULT pnak_snmp_get_data(unsigned short a1, T_PNAK_OID* a2, void* a3, PN_U32* a4, PN_U32* a5,
                                 unsigned char a6, PN_BOOL a7)
{
  return PNAK_OK;
}
T_PNAK_RESULT pnak_snmp_check_data(unsigned short a1, T_PNAK_OID* a2, void* a3, PN_U32 a4, PN_U32 a5,
                                   unsigned char a6)
{
  return PNAK_OK;
}
T_PNAK_RESULT pnak_snmp_set_data(unsigned short a1, T_PNAK_OID* a2, void* a3, PN_U32 a4, PN_U32 a5)
{
  return PNAK_OK;
}
...
T_PNAK_RESULT pnak_send_service_req_res(unsigned short a1, const T_PNAK_SERVICE_REQ_RES* a2)
{
  return PNAK_OK;
}
...
T_PNAK_RESULT pnak_set_device_state(unsigned short a1, const T_PNAK_EVENT_SET_DEVICE_STATE* a2)
{
  return PNAK_OK;
}
...
T_PNAK_RESULT pnak_set_iocr_data(unsigned short a1, unsigned short a2, const unsigned char* a3,
                                 unsigned short a4, unsigned char a5)
{
  return PNAK_OK;
}

T_PNAK_RESULT pnak_get_iocr_data(unsigned short a1, unsigned short a2, unsigned char* a3, unsigned short* a4,
                                 unsigned char* a5, unsigned char* a6)
{
  return PNAK_OK;
}
T_PNAK_RESULT pnak_get_consumer_data_changed_ind(unsigned short a1, T_PNAK_DATA_CONSUMER_DATA_CHANGED* a2)
{
  return PNAK_OK;
}
T_PNAK_RESULT pnak_get_provider_data_updated(unsigned short a1, T_PNAK_DATA_PROVIDER_DATA_UPDATED* a2)
{
  return PNAK_OK;
}
