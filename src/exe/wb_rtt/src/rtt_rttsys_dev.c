...
int rttsys_start_grafcet_monitor(menu_ctx ctx, pwr_tObjid plc_objid) { return RTT__SUCCESS; }

int rttsys_start_system_picture(menu_ctx ctx, char* picture_name) { return RTT__SUCCESS; }

int rttsys_get_current_logg_entry(int* entry) { return RTT__SUCCESS; }

int rttsys_get_login_picture(rtt_t_backgr** picture) { return RTT__SUCCESS; }
...
int RTTSYS_ERROR(menu_ctx ctx, int event, char* parameter_ptr, char* objectname, char** picture)
{
  return RTT__SUCCESS;
}
...
int RTTSYS_WATCHDOG(menu_ctx ctx, int event, char* parameter_ptr, char* objectname, char** picture)
{
  return RTT__SUCCESS;
}
...
int RTTSYS_OBJECT_NMPSCELL(menu_ctx ctx, int event, char* parameter_ptr, char* objectname, char** picture)
{
  return RTT__SUCCESS;
}
