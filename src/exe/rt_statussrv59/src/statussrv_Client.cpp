                                                    ...
                                                    _s0__GetStatusResponse* s0__GetStatusResponse)
{
  ...
  if (soap_end_count(soap))
    return soap->error;
  if (soap_connect(soap, soap_endpoint, soap_action) || soap_envelope_begin_out(soap) ||
  ...
  if (soap_begin_recv(soap) || soap_envelope_begin_in(soap) || soap_recv_header(soap) ||
                                                  ...
                                                  _s0__RestartResponse* s0__RestartResponse)
{
  ...
  {
    if (soap_envelope_begin_out(soap) || soap_putheader(soap) || soap_body_begin_out(soap) ||
        soap_put___s0__Restart(soap, &soap_tmp___s0__Restart, "-s0:Restart", "") || soap_body_end_out(soap) ||
