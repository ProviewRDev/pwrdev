...
void* CnvXtthelpToHtml::insert(navh_eItemType item_type, const char* text1, const char* text2,
                               ...
                               const char* bookmark, int coding)
{
  ...
  case navh_eItemType_Topic:
  {
    ...
    fp << "<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.0 "
       ...
       << "<HTML>\n"
       << "<HEAD>\n"
       << "<META http-equiv=\"Content-Type\" content=\"text/html; charset=" << codingstr << "\">\n"
