...
#define pwr_mClassDef_HasRef                                                                                 \
  (pwr_mClassDef_ObjXRef | pwr_mClassDef_AttrXRef | pwr_mClassDef_ObjRef | pwr_mClassDef_AttrRef)
  };
...
#define pwr_mObjBodyDef_rtvirtual pwr_Bit(6) /*  64	  */
  ...
  */
  ...
  {
    pwr_tBitMask m;
    pwr_32Bits(pwr_Bits(pointer, 1), pwr_Bits(array, 1), pwr_Bits(redutransfer, 1), pwr_Bits(castattr, 1),
               pwr_Bits(state, 1), pwr_Bits(constant, 1), pwr_Bits(rtvirtual, 1), pwr_Bits(devbodyref, 1),

               pwr_Bits(dynamic, 1), pwr_Bits(publicwrite, 1), pwr_Bits(noedit, 1), pwr_Bits(invisible, 1),
               pwr_Bits(refdirect, 1), pwr_Bits(noinvert, 1), pwr_Bits(noremove, 1), pwr_Bits(rtdbref, 1),

               pwr_Bits(privatepointer, 1), pwr_Bits(isclass, 1), /* class is a reserved word */
               pwr_Bits(superclass, 1), pwr_Bits(buffer, 1), pwr_Bits(nowbl, 1), pwr_Bits(alwayswbl, 1),
               pwr_Bits(disableattr, 1), pwr_Bits(rthide, 1),

               pwr_Bits(newattribute, 1), pwr_Bits(devhidevalue, 1), pwr_Bits(fill_1, 6), , , , , ) b;
