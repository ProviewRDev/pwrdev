...
#define pwrv_cBuildTimeStr "26-MAY-2023 12:00:00"

#define pwrv_cPwrVersionStr "V6.1.0"
#define pwrv_cPwrVersion SET_VERSION('V', 6, 1, 0)

#define pwrv_cWbdbVersionShortStr "V61"
#define pwrv_cPwrCopyright "Copyright (C) 2005-2023 SSAB EMEA AB"
