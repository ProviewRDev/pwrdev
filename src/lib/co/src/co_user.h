...
#define FSPACE " "
  ...
  public:
    ...
    int add_user(pwr_tOix ident, char* user, char* password, pwr_tMask priv, char* fullname, char* descr,
                 char* phone, char* email, char* sms);
  ...
  public:
    UserList(pwr_tOix ul_id, const char* ul_name, const char* ul_password, pwr_tMask ul_priv,
             const char* ul_fullname, const char* ul_description, const char* ul_email, const char* ul_phone,
             const char* ul_sms);
  ...
  public:
    ...
    void print(int brief);
    void print_all(int brief);
    void modify(char* password, pwr_tMask priv, char* fullname, char* description, char* email, char* phone,
                char* sms);
  ...
  public:
    ...
    int add_user(char* system, char* user, char* password, unsigned int priv, char* fullname,
                 char* description, char* email, char* phone, char* sms, pwr_tOix id = user_cNId);
    int remove_user(char* system, char* user);
    int modify_user(char* system, char* user, char* password, unsigned int priv, char* fullname,
                    char* description, char* email, char* phone, char* sms);
    int get_user_data(char* system, char* user, char* password, pwr_tMask* priv, pwr_tOix* id, char* fullname,
                      char* description, char* email, char* phone, char* sms);
    ...
    int get_user(const char* system, const char* user, const char* password, unsigned int* priv);
