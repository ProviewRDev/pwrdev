...
#define DCLI_RECALL_MAX 30
  ...
  int dcli_get_input_command(dcli_sChannel* chn, const char* prompt, char* cmd, int maxlen,
                             dcli_sRecall* recall_buf);
  int dcli_get_input_string(dcli_sChannel* chn, char* out_string, unsigned long* out_terminator,
                            int out_maxlen, dcli_sRecall* recall, unsigned long option, int timeout,
                            int (*timeout_func)(), void* timeout_arg, const char* prompt);
