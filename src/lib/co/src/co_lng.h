...
#include "co_tree.h"
  ...
  public:
    ...
    static char* get(int item) { return items[lang][item]; }
    static char* get(lng_eLanguage language, int item) { return items[language][item]; }
    ...
    static void read_include(std::ifstream& fp1, std::ifstream& fp2, bool global, pwr_tStatus* sts);
