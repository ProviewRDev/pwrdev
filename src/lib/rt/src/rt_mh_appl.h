...
extern "C"
{
  ...
  struct mhs_ApplMessage
  {
    pwr_tUInt32 Id;               /**< The identity given to the message, which is used as a
                                     ...
                                     its own.*/
    pwr_tObjid Object;            /**< An object that is associated with the event. When the
                                     operator
    ...
    mh_mEventFlags EventFlags;    /**< Flags that modify the properties of a message, See
                                     mh_mEventFlags.*/
   ...
   */
  pwr_tStatus mh_ApplConnect(pwr_tObjid ApplObject, mh_mApplFlags Flags, const pwr_tString80 AbortEventName,
                             mh_eEvent AbortEventType, mh_eEventPrio AbortEventPrio,
                             mh_mEventFlags AbortEventFlags, const pwr_tString80 AbortEventText,
