...
#define RTT_MENU_UPDATE(title, parameter, priv) {title, 0, 0, parameter, "", priv, 0, 0, 0, 0, 0.0, 0.0},
...
#define RTT_MENU_SET(title, parameter, priv)                                                                 \
  {title, &rtt_menu_parameter_set, 0, parameter, "", priv | RTT_MENU_NOINPUT, 0, 0, 0, 0, 0.0, 0.0},
...
#define RTT_MENU_RESET(title, parameter, priv)                                                               \
  {title, &rtt_menu_parameter_reset, 0, parameter, "", priv | RTT_MENU_NOINPUT, 0, 0, 0, 0, 0.0, 0.0},
...
#define RTT_MENU_SET_RESET(title, parameter, priv)                                                           \
  {title,                                                                                                    \
   &rtt_menu_parameter_set,                                                                                  \
   &rtt_menu_parameter_reset,                                                                                \
   parameter,                                                                                                \
   "",                                                                                                       \
   priv | RTT_MENU_NOINPUT,                                                                                  \
   0,                                                                                                        \
   0,                                                                                                        \
   0,                                                                                                        \
   0,                                                                                                        \
...
#define RTT_MENU_TOGGLE(title, parameter, priv)                                                              \
  {title, &rtt_menu_parameter_toggle, 0, parameter, "", priv | RTT_MENU_NOINPUT, 0, 0, 0, 0, 0.0, 0.0},
...
#define RTT_MENU_DUAL_TOGGLE(title, show_parameter, toggle_parameter, priv)                                  \
  {title,                                                                                                    \
   &rtt_menu_parameter_dual_toggle,                                                                          \
   0,                                                                                                        \
   show_parameter,                                                                                           \
   toggle_parameter,                                                                                         \
   priv | RTT_MENU_NOINPUT,                                                                                  \
...
#define RTT_MENUITEM_OBJECTS(title) {title, &rtt_hierarchy, 0, 0, NULLOI, 0, 0, 0, 0},

#define RTT_MENUITEM_EXIT(title) {title, &rtt_exit, &rtt_exit, 0, NULLOI, 0, 0, 0, 0},
...
#define RTT_MENU_NEW(title, menu_name)                                                                       \
  {title, &rtt_menu_new, 0, 0, NULLOI, (void*)&menu_name##_ptr, (void*)title, 0, (void*)RTT_MENUTYPE_STAT},

#define RTT_MENU_KEYS_NEW(title, menu_name)                                                                  \
  {title, &rtt_menu_keys_new,      0, 0, NULLOI, (void*)&menu_name##_ptr, (void*)title,                      \
   0,     (void*)RTT_MENUTYPE_STAT},

#define RTT_MENU_UPDATE_NEW(title, menu_name)                                                                \
  {title, &rtt_menu_new_update,   0, 0, NULLOI, (void*)&menu_name##_ptr, (void*)title,                       \
   0,     (void*)RTT_MENUTYPE_DYN},
...
#define RTT_MENU_SYSEDIT_NEW(title, objectname, function)                                                    \
  {title, &rtt_menu_new_sysedit, 0, 0, NULLOI, (void*)objectname, (void*)title, 0, (void*)function},
