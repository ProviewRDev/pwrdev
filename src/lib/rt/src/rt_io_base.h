...
void io_DiUnpackWord(io_sCard *cp, pwr_tUInt16 data, pwr_tUInt16 mask,
                     int index);
...
void io_ConvertAi(pwr_sClass_ChanAi *cop, pwr_tInt16 rawvalue,
                  pwr_tFloat32 *actvalue_p);

void io_ConvertAi32(pwr_sClass_ChanAi *cop, pwr_tInt32 rawvalue,
                    pwr_tFloat32 *actvalue_p);

void io_ConvertAit(pwr_sClass_ChanAit *cop, pwr_tInt16 rawvalue,
                   pwr_tFloat32 *actvalue_p);

pwr_tStatus io_init_signals(void);

pwr_tStatus io_get_iohandler_object(pwr_sClass_IOHandler **ObjPtr,
                                    pwr_tObjid *oid);

pwr_tStatus io_GetIoTypeClasses(io_eType type, pwr_tClassId **classes,
                                int *size);
