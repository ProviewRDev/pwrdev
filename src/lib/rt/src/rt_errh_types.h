...
#ifndef rt_errh_types_h
#define rt_errh_types_h
...
/*! \file rt_errh_types.h
    \brief Common types and constants for ProviewR error handling system.
*/
...
#define LOG_QUEUE_MAX_MSG_SIZE 2048 /* 2kb messages as per rfc5424 */
#define LOG_MAX_MSG_SIZE (LOG_QUEUE_MAX_MSG_SIZE - 24)

#define errh_cAnix_SrvSize 40
#define errh_cAnix_PlcSize 20

  /**
   * Application index enumeration
   */
  typedef enum
  {
    errh_eNAnix = 0,
