...
void valve_exec(plc_sThread* tp, pwr_sClass_valve* object)
{
  ...
  /* Sum Alarm */
  object->SumAlarm = object->Alarm1 || object->Alarm2 || object->Alarm3 || object->Alarm4;

  /* Set order and indications */
  object->OrderOpen = open;
  object->IndOpen = open && object->EndOpen && !object->EndClose && !object->Local;
  object->IndClose = !open && object->EndClose && !object->EndOpen && !object->Local;
...
void mvalve_exec(plc_sThread* tp, pwr_sClass_mvalve* object)
{
  ...
  /* Remove old alarms */
  if (((object->AutoOpen || object->ProdOpen || object->SafeOpen) && !oold) || object->ManOpen ||
      object->ManStop)
  {
    object->Alarm5 = FALSE; /* New open */
  }

  if (((object->AutoClose || object->ProdClose || object->SafeClose) && !cold) || object->ManClose ||
      object->ManStop)
  {
  ...
  object->OrderOpen = (object->EndOpen || close || (object->Status <= 0)) ? FALSE : open;
  object->OrderClose = (object->EndClose || (object->Status >= 0)) ? FALSE : close;
  object->IndOpen = object->EndOpen && !object->EndClose && !close && !object->Local;
  object->IndClosed = !object->EndOpen && object->EndClose && !open && !object->Local;
  ...
  /* Sum Alarm*/
  object->SumAlarm = object->Alarm1 || object->Alarm2 || object->Alarm3 || object->Alarm4 || object->Alarm5 ||
                     object->Alarm6;
...
void posit_exec(plc_sThread* tp, pwr_sClass_posit* object)
{
  ...
  if ((object->PosError <= object->DeadZone1) && (object->PosError >= -object->DeadZone2))
  {
    object->InPlace = TRUE;
  }
  else
