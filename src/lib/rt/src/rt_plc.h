...
typedef struct {
  ...
  IO_AREA(pwr_sClass_EiArea) ei_a;
  IO_AREA(pwr_sClass_EoArea) eo_a;
  IO_AREA(pwr_sClass_EvArea) ev_a;
  IO_AREA(pwr_sClass_ATvArea) atv_a;
  IO_AREA(pwr_sClass_DTvArea) dtv_a;
  IO_AREA(pwr_sClass_SiArea) si_a;
  IO_AREA(pwr_sClass_SoArea) so_a;
