...
#define gdh_ClassNameToNumber gdh_ClassNameToId
  ...
  pwr_tStatus gdh_AttrrefToName(pwr_sAttrRef* attributeReference, char* nameBuffer,
                                unsigned int sizeOfNameBuffer, pwr_tBitMask nameType);

  pwr_tStatus gdh_AttrRefToPointer(pwr_sAttrRef* arp, void** p);

  pwr_tStatus gdh_AttrStringToValue(int type_id, char* value_str, void* buffer_ptr, int buff_size,
                                    int attr_size);

  pwr_tStatus gdh_AttrValueToString(pwr_eType type_id, pwr_tTid tid, void* value_ptr, char* str, int size,
                                    int* len, char* format);

  pwr_tStatus gdh_ClassAttrrefToAttr(pwr_tClassId classid, pwr_sAttrRef* attributeReference, char* nameBuffer,
                                     int sizeOfNameBuffer);

  pwr_tStatus gdh_ClassAttrToAttrref(pwr_tClassId classid, const char* attributeName,
                                     pwr_sAttrRef* attributeReference);

  pwr_tStatus gdh_ClassNameToId(const char* className, pwr_tClassId* classid);

  pwr_tStatus gdh_CreateObject(char* objectName, pwr_tClassId classid, unsigned int sizeOfObjectData,
                               pwr_tObjid* objectId, pwr_tObjid internal1, pwr_tBitMask internal2,
  ...
  pwr_tStatus gdh_DLRefObjectInfoAttrref(pwr_sAttrRef* addressOfAttributeReference, void** objectData,
  ...
  pwr_tStatus gdh_GetAlarmInfo(pwr_tObjid object, pwr_tUInt32* alarmLevel, pwr_tUInt32* maxAlarmLevel,
                               pwr_tUInt32* alarmBlockLevel, pwr_tUInt32* maxAlarmBlockLevel,
                               pwr_tUInt32* alarmVisibility);

  pwr_tStatus gdh_GetAttributeCharAttrref(pwr_sAttrRef* attributeReference, pwr_tTypeId* attributeType,
                                          unsigned int* attributeSize, unsigned int* attributeOffset,
                                          unsigned int* attributeDimension);

  pwr_tStatus gdh_GetAttributeFlags(pwr_sAttrRef* arp, unsigned int* flags);

  pwr_tStatus gdh_GetAttributeCharacteristics(char* name, pwr_tTypeId* tid, pwr_tUInt32* size,
                                              pwr_tUInt32* offs, pwr_tUInt32* elem);
  ...
  pwr_tStatus gdh_GetObjectInfoAttrref(pwr_sAttrRef* attributeReference, void* buffer,
  ...
  pwr_tStatus gdh_GetSubscriptionOldness(pwr_tSubid subid, pwr_tBoolean* isOld, pwr_tTime* lastUpdate,
  ...
  pwr_tStatus gdh_RefObjectInfo(char* attributeName, void** objectData, pwr_tSubid* subid,
  ...
  pwr_tStatus gdh_SetObjectInfoAttrref(pwr_sAttrRef* attributeReference, void* buffer,
                                       unsigned int sizeOfBuffer);
  ...
  pwr_tStatus gdh_SubRefObjectInfoList(unsigned int entryCount, void* object[], pwr_tBoolean isAttrref[],
                                       pwr_tSubid subid[]);
  ...
  pwr_tStatus gdh_MDAttribute(pwr_tClassId classid, pwr_sAttrRef* attributeReference, char* attributeName,
                              pwr_tTypeId* attributeType, unsigned int* attributeSize,
                              unsigned int* attributeOffset, unsigned int* attributeDimension);

  pwr_tStatus gdh_SetCache(pwr_tUInt32 activation_level, pwr_tUInt32 trimmed_level);
