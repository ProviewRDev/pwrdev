...
typedef union
{
  struct
  {
    pwr_Endian_4(unsigned long int offs : pool_cOffsBits;, /* offset in section, in quadwords */
...
typedef union
{
  struct
  {
    pwr_Endian_4(pwr_Bits(offs, pool_cOffsBits), /* offset in section, in quadwords */
