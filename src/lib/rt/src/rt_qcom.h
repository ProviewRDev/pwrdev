...
#define qcom_mNode_ (~qcom_mNode__)
  ...
  pwr_tBoolean qcom_WaitAnd(pwr_tStatus* status, const qcom_sQid* qid, const qcom_sQid* eid, int mask,
                            int tmo);
  ...
  void* qcom_Request(pwr_tStatus* sts, const qcom_sQid* receiver, qcom_sPut* put, const qcom_sQid* myQ,
                     qcom_sGet* get, int tmo_ms, pwr_tBitMask flags);
