...
gdb_sObject* dvol_AdoptObject(pwr_tStatus* sts, gdb_sObject* op, gdb_sObject* p_op, net_sNotify* nmp);
...
gdb_sObject* dvol_UnadoptObject(pwr_tStatus* sts, gdb_sObject* op, gdb_sObject* pop, net_sNotify* nmp);
