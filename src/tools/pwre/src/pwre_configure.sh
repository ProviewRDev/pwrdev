...
#    fi
    ...
    pwre_config_check_lib libsnmp   PNAK  lib pnak 1 "/usr/lib/libsnmp.so:/usr/lib/$hwpl-linux-$gnu/libsnmp.so:/usr/lib64/libsnmp.so"
    pwre_config_check_lib libnetsnmpagent PNAK lib pnak 1 "/usr/lib/libnetsnmpagent.so:/usr/lib/$hwpl-linux-$gnu/libnetsnmpagent.so:/usr/lib64/libnetsnmpagent.so"
    pwre_config_check_lib libnetsnmpmibs PNAK lib pnak 1 "/usr/lib/libnetsnmpmibs.so:/usr/lib/$hwpl-linux-$gnu/libnetsnmpmibs.so:/usr/lib64/libnetsnmpmibs.so"
    pwre_config_check_lib libnetsnmphelpers PNAK lib pnak 1 "/usr/lib/libnetsnmphelpers.so:/usr/lib/$hwpl-linux-$gnu/libnetsnmphelpers.so:/usr/lib64/libnetsnmphelpers.so"
    pwre_config_check_lib libnetsnmptrapd PNAK lib pnak 1 "/usr/lib/libnetsnmptrapd.so:/usr/lib/$hwpl-linux-$gnu/libnetsnmptrapd.so:/usr/lib64/libnetsnmptrapd.so"
