...
void proto_register_redcom(void)
{
  ...
  static hf_register_info hf[] = {
      {&hf_redcom, {"Data", "redcom.data", FT_NONE, BASE_NONE, NULL, 0x0, "REDCOM Data", HFILL}},

      /* Redcom Header */
      {&hf_redcom_header, {"Header", "redcom.header", FT_NONE, BASE_NONE, NULL, 0x0, "REDCOM Header", HFILL}},
      {&hf_redcom_header_nodeid,
       {"NodeId", "redcom.header.nodeid", FT_UINT32, BASE_HEX, NULL, 0x0, NULL, HFILL}},
      {&hf_redcom_header_birth, {"Birth", "redcom.header.birth", FT_INT32, BASE_DEC, NULL, 0x0, NULL, HFILL}},
      ...
      {&hf_redcom_header_prio, {"Prio", "redcom.header.prio", FT_INT32, BASE_DEC, NULL, 0x0, NULL, HFILL}},
      {&hf_redcom_header_state, {"State", "redcom.header.state", FT_INT32, BASE_DEC, NULL, 0x0, NULL, HFILL}},

      /* Redcom Info */
      {&hf_redcom_info, {"Info", "redcom.info", FT_NONE, BASE_NONE, NULL, 0x0, "REDCOM Info", HFILL}},
      ...
      {&hf_redcom_info_pid, {"Pid", "redcom.info.pid", FT_UINT32, BASE_DEC, NULL, 0x0, NULL, HFILL}},
      ...
      {&hf_redcom_info_btype, {"BType", "redcom.info.btype", FT_INT32, BASE_DEC, NULL, 0x0, NULL, HFILL}},
      {&hf_redcom_info_stype, {"SType", "redcom.info.stype", FT_INT32, BASE_DEC, NULL, 0x0, NULL, HFILL}},
      {&hf_redcom_info_rid, {"Rid", "redcom.info.rid", FT_INT32, BASE_DEC, NULL, 0x0, NULL, HFILL}},
      {&hf_redcom_info_size, {"Size", "redcom.info.size", FT_UINT32, BASE_DEC, NULL, 0x0, NULL, HFILL}},
      {&hf_redcom_info_tmo, {"Tmo", "redcom.info.tmo", FT_INT32, BASE_DEC, NULL, 0x0, NULL, HFILL}},
      {&hf_redcom_info_status, {"Status", "redcom.info.status", FT_INT32, BASE_DEC, NULL, 0x0, NULL, HFILL}},
      {&hf_redcom_info_flags, {"Flags", "redcom.info.flags", FT_UINT32, BASE_HEX, NULL, 0x0, NULL, HFILL}},
      ...
      {&hf_redu_msgheader_version,
       {"Version", "redcom.msgheader.version", FT_ABSOLUTE_TIME, ABSOLUTE_TIME_LOCAL, NULL, 0x0, NULL,
        HFILL}},

      /* Redu TableMsgHeader */
      {&hf_redu_tablemsgheader,
       {"MsgTableHeader", "redcom.tablemsgheader", FT_NONE, BASE_NONE, NULL, 0x0, "Redcom TableMsg Header",
        HFILL}},
      ...
      {&hf_redu_tablemsgheader_version,
       {"Version", "redcom.redu.tablemsgheader.version", FT_ABSOLUTE_TIME, ABSOLUTE_TIME_LOCAL, NULL, 0x0,
        NULL, HFILL}},

      /* Redu TableReqMsgHeader */
      {&hf_redu_tablereqmsgheader,
       {"MsgTableReqHeader", "redcom.tablereqmsgheader", FT_NONE, BASE_NONE, NULL, 0x0,
        "Redcom TableReqeustMsg Header", HFILL}},
      ...
      {&hf_redu_tableversionreqmsgheader,
       {"MsgTableVersionReqHeader", "redcom.tableversionreqmsgheader", FT_NONE, BASE_NONE, NULL, 0x0,
      ...
      {&hf_redu_tableversionmsgheader,
       {"MsgTableVersionHeader", "redcom.tableversionmsgheader", FT_NONE, BASE_NONE, NULL, 0x0,
        "Redcom TableVersionMsg Header", HFILL}},
...
int dissect_redcom(tvbuff_t* tvb, packet_info* pinfo, proto_tree* tree, void*)
{
  ...
  { /* we are being asked for details */
    ...
    /* Header map */
    redcom_sub_item = proto_tree_add_item(redcom_tree, hf_redcom_header, tvb, offset, header_size, FALSE);

    redcom_header_tree = proto_item_add_subtree(redcom_sub_item, ett_redcom);

    redcom_sub_item =
        proto_tree_add_item(redcom_header_tree, hf_redcom_header_nodeid, tvb, offset, 4, ENC_BIG_ENDIAN);
    offset += 4;
    redcom_sub_item =
        proto_tree_add_item(redcom_header_tree, hf_redcom_header_birth, tvb, offset, 4, ENC_BIG_ENDIAN);
    offset += 4;
    redcom_sub_item =
        proto_tree_add_item(redcom_header_tree, hf_redcom_header_flags, tvb, offset, 4, ENC_BIG_ENDIAN);
    offset += 4;
    redcom_sub_item = proto_tree_add_item(redcom_header_tree, hf_redcom_header_lacksequence, tvb, offset, 4,
                                          ENC_BIG_ENDIAN);
    offset += 4;
    redcom_sub_item = proto_tree_add_item(redcom_header_tree, hf_redcom_header_lacktimestamp, tvb, offset, 4,
                                          ENC_BIG_ENDIAN);
    offset += 4;
    redcom_sub_item = proto_tree_add_item(redcom_header_tree, hf_redcom_header_racksequence, tvb, offset, 4,
                                          ENC_BIG_ENDIAN);
    offset += 4;
    redcom_sub_item = proto_tree_add_item(redcom_header_tree, hf_redcom_header_racktimestamp, tvb, offset, 4,
                                          ENC_BIG_ENDIAN);
    offset += 4;
    redcom_sub_item =
        proto_tree_add_item(redcom_header_tree, hf_redcom_header_prio, tvb, offset, 4, ENC_BIG_ENDIAN);
    offset += 4;
    redcom_sub_item =
        proto_tree_add_item(redcom_header_tree, hf_redcom_header_state, tvb, offset, 4, ENC_BIG_ENDIAN);
    offset += 4;

    if (is_user)
    {
      /* Info map */
      redcom_sub_item = proto_tree_add_item(redcom_tree, hf_redcom_info, tvb, offset, info_size, FALSE);

      redcom_info_tree = proto_item_add_subtree(redcom_sub_item, ett_redcom);

      redcom_sub_item =
          proto_tree_add_item(redcom_info_tree, hf_redcom_info_senderaix, tvb, offset, 4, ENC_BIG_ENDIAN);
      offset += 4;
      redcom_sub_item =
          proto_tree_add_item(redcom_info_tree, hf_redcom_info_sendernid, tvb, offset, 4, ENC_BIG_ENDIAN);
      offset += 4;
      redcom_sub_item =
          proto_tree_add_item(redcom_info_tree, hf_redcom_info_pid, tvb, offset, 4, ENC_BIG_ENDIAN);
      offset += 4;
      redcom_sub_item =
          proto_tree_add_item(redcom_info_tree, hf_redcom_info_receiverqix, tvb, offset, 4, ENC_BIG_ENDIAN);
      offset += 4;
      redcom_sub_item =
          proto_tree_add_item(redcom_info_tree, hf_redcom_info_receivernid, tvb, offset, 4, ENC_BIG_ENDIAN);
      offset += 4;
      redcom_sub_item =
          proto_tree_add_item(redcom_info_tree, hf_redcom_info_replyqix, tvb, offset, 4, ENC_BIG_ENDIAN);
      offset += 4;
      redcom_sub_item =
          proto_tree_add_item(redcom_info_tree, hf_redcom_info_replynid, tvb, offset, 4, ENC_BIG_ENDIAN);
      offset += 4;
      redcom_sub_item =
          proto_tree_add_item(redcom_info_tree, hf_redcom_info_btype, tvb, offset, 4, ENC_BIG_ENDIAN);
      offset += 4;
      redcom_sub_item =
          proto_tree_add_item(redcom_info_tree, hf_redcom_info_stype, tvb, offset, 4, ENC_BIG_ENDIAN);
      offset += 4;
      redcom_sub_item =
          proto_tree_add_item(redcom_info_tree, hf_redcom_info_rid, tvb, offset, 4, ENC_BIG_ENDIAN);
      offset += 4;
      redcom_sub_item =
          proto_tree_add_item(redcom_info_tree, hf_redcom_info_size, tvb, offset, 4, ENC_BIG_ENDIAN);
      offset += 4;
      redcom_sub_item =
          proto_tree_add_item(redcom_info_tree, hf_redcom_info_tmo, tvb, offset, 4, ENC_BIG_ENDIAN);
      offset += 4;
      redcom_sub_item =
          proto_tree_add_item(redcom_info_tree, hf_redcom_info_status, tvb, offset, 4, ENC_BIG_ENDIAN);
      offset += 4;
      redcom_sub_item =
          proto_tree_add_item(redcom_info_tree, hf_redcom_info_flags, tvb, offset, 4, ENC_BIG_ENDIAN);
      offset += 4;
      ...
      if (is_reducyclic)
      {
        /* Redu cyclic */
        redcom_sub_item =
            proto_tree_add_item(redcom_tree, hf_redu_msgheader, tvb, offset, reducyclic_size, FALSE);

        redcom_redu_cyclic_tree = proto_item_add_subtree(redcom_sub_item, ett_redcom);

        redcom_sub_item = proto_tree_add_item(redcom_redu_cyclic_tree, hf_redu_msgheader_type, tvb, offset, 4,
                                              local_endian);
        offset += 4;
        redcom_sub_item = proto_tree_add_item(redcom_redu_cyclic_tree, hf_redu_msgheader_size, tvb, offset, 4,
                                              local_endian);
        offset += 4;
        redcom_sub_item = proto_tree_add_item(redcom_redu_cyclic_tree, hf_redu_msgheader_version, tvb, offset,
                                              8, local_endian);
        offset += 8;
      }
      else if (is_redutable)
      {
        /* Redu table */
        redcom_sub_item =
            proto_tree_add_item(redcom_tree, hf_redu_tablemsgheader, tvb, offset, redutable_size, FALSE);

        redcom_redu_table_tree = proto_item_add_subtree(redcom_sub_item, ett_redcom);

        redcom_sub_item = proto_tree_add_item(redcom_redu_table_tree, hf_redu_tablemsgheader_type, tvb,
                                              offset, 4, local_endian);
        offset += 4;
        redcom_sub_item = proto_tree_add_item(redcom_redu_table_tree, hf_redu_tablemsgheader_size, tvb,
                                              offset, 4, local_endian);
        offset += 4;
        redcom_sub_item = proto_tree_add_item(redcom_redu_table_tree, hf_redu_tablemsgheader_attributes, tvb,
                                              offset, 4, local_endian);
        offset += 4;
        redcom_sub_item = proto_tree_add_item(redcom_redu_table_tree, hf_redu_tablemsgheader_version, tvb,
                                              offset, 8, local_endian);
        offset += 8;
      }
      else if (is_redutablerequest)
      {
        ...
        redcom_sub_item =
            proto_tree_add_item(redcom_tree, hf_redu_tablereqmsgheader, tvb, offset, redutable_size, FALSE);
      ...
      {
        /* redu table request message map */
        redcom_sub_item = proto_tree_add_item(redcom_tree, hf_redu_tableversionreqmsgheader, tvb, offset,
                                              redutable_size, FALSE);

        redcom_redu_tableversionrequest_tree = proto_item_add_subtree(redcom_sub_item, ett_redcom);

        redcom_sub_item =
            proto_tree_add_item(redcom_redu_tableversionrequest_tree, hf_redu_tableversionreqmsgheader_type,
                                tvb, offset, 4, local_endian);
        offset += 4;
      }
      ...
      {
        /* redu table request message map */
        redcom_sub_item = proto_tree_add_item(redcom_tree, hf_redu_tableversionmsgheader, tvb, offset,
                                              redutable_size, FALSE);

        redcom_redu_tableversion_tree = proto_item_add_subtree(redcom_sub_item, ett_redcom);

        redcom_sub_item = proto_tree_add_item(
            redcom_redu_tableversion_tree, hf_redu_tableversionmsgheader_type, tvb, offset, 4, local_endian);
        offset += 4;
      }
    }
  }
