...
EPLDLLEXPORT tEplKernel PUBLIC EplApiProcessImageAlloc(unsigned int uiSizeProcessImageIn_p,
...
EPLDLLEXPORT tEplKernel PUBLIC EplApiWriteLocalObject(unsigned int uiIndex_p, unsigned int uiSubindex_p,
                                                      void* pSrcData_p, unsigned int uiSize_p)
{
  return 0;
}
EPLDLLEXPORT tEplKernel PUBLIC EplApiReadLocalObject(unsigned int uiIndex_p, unsigned int uiSubindex_p,
...
EPLDLLEXPORT tEplKernel PUBLIC EplApiProcessImageLinkObject(unsigned int uiObjIndex_p,
                                                            unsigned int uiFirstSubindex_p,
                                                            unsigned int uiOffsetPI_p, BOOL fOutputPI_p,
                                                            tEplObdSize EntrySize_p,
                                                            unsigned int* puiVarEntries_p)
{
  return 0;
}
EPLDLLEXPORT tEplKernel PUBLIC EplApiProcessImageExchange(tEplApiProcessImageCopyJob* pCopyJob_p)
{
  return 0;
}
