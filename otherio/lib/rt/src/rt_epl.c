...
static tEplKernel EplApiProcessImageLinkRange(unsigned int uiObjIndexStart_p, unsigned int uiObjIndexEnd_p,
                                              ...
                                              tEplObdSize EntrySize_p, unsigned int uiSubindexCountPerIndex_p)
{
       ...
       uiObjIndexStart_p++, uiOffsetPI_p += EntrySize_p * uiSubindexCountPerIndex_p)
  {
    ...
    Ret = EplApiProcessImageLinkObject(uiObjIndexStart_p, 1, uiOffsetPI_p, fOutputPI_p, EntrySize_p,
                                       &uiVarEntries);
