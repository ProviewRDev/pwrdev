...
/* rt_io_m_mqtt_device.c -- I/O methods for class Zigbee2MQTT_Device. */
...
{
  io_sCardLocal* clocal = (io_sCardLocal*)cp->Local;
...
pwr_dExport pwr_BindIoMethods(Zigbee2MQTT_Device) = { pwr_BindIoMethod(IoCardInit),
