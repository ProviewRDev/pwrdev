...
extern "C"
{
  ...
  PAMSIMPORT int32 PAMSAPI pams_bind_q(q_address*, /* ptr to address to be bound          */
  ...
  PAMSIMPORT int32 PAMSAPI pams_read_jrn(int32*, char*, char*, int32*, int16*, int16*, int16*, int16*, int32*,
                                         uint32*, int32*, uint32*, int32*, int32*, int32*, char*);
  ...
  PAMSIMPORT int32 PAMSAPI putil_print_status(char*, /* ptr to string process name          */
                                              char*, /* ptr to string message               */
                                              int    /* status return                       */
  );

  PAMSIMPORT int32 PAMSAPI putil_show_pending(int32*, /* count - ptr to number of queues     */
  ...
  PAMSIMPORT int32 PAMSAPI pams_set_select(selection_array_component*, /* selection array               */
                                           short*, /* number of select masks in array     */
                                           int32*  /* returned select-var for get         */
  );

  PAMSIMPORT int32 PAMSAPI pams_cancel_select(int32* /* select var from set select          */
  );
