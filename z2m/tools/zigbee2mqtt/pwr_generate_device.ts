...
import {pwrGenerateExpose} from './pwr_device_page_exposes';
import {pwrGenerateOptions} from './pwr_device_page_options';
...
export default async function pwrGenerateDevice(device) {
...
${pwrGenerateOptions(device)}
${pwrGenerateExpose(device)}
`;

    console.log("**EndDevice");
